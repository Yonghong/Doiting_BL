# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/bloop//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
# 30 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
...
# 31 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 2
...
# 32 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 2
...
# 33 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 2
...
# 35 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 2
...
# 36 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 2
...
# 37 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/include/utils_debug.h" 1
# 38 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 2
...
int bloop_handler_register(struct loop_ctx *loop, const struct loop_evt_handler *handler, int priority)
{
    ...
    if (
# 63 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 3 4
       ((void *)0) 
# 63 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
            == loop->handlers[priority]) {
        i = priority;
    } else {
        for (i = priority; i < (32); i++) {
            if (
# 67 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 3 4
               ((void *)0) 
# 67 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
                    == loop->handlers[priority]) {
                break;
            }
        }
...
int bloop_handler_unregister(struct loop_ctx *loop, const struct loop_evt_handler *handler, int priority)
{
    ...
    if (
# 87 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 3 4
       ((void *)0) 
# 87 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
            == loop->handlers[priority]) {
    ...
    loop->handlers[priority] = 
# 96 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 3 4
                              ((void *)0)
# 96 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
                                  ;
    return 0;
}
...
# 136 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 3 4
                             ((void *)0)
# 136 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
                                 , *node_pre = 
# 136 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 3 4
                                               ((void *)0)
# 136 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
    ...
    if (utils_dlist_empty(&loop->timer_dlist)) {
        ...
        for (node = ((struct loop_timer *) ((char *) ((&loop->timer_dlist)->next) - ((size_t)&(((struct loop_timer *)0)->dlist_item)))); &node->dlist_item != (&loop->timer_dlist); node = ((struct loop_timer *) ((char *) (node->dlist_item.next) - ((size_t)&(((struct loop_timer *)0)->dlist_item))))) {
            if ((int)timer->time_target - (int)node->time_target <= 0) {
                ...
                if (
# 144 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 3 4
                   ((void *)0) 
# 144 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
                        == node_pre) {
...
# 181 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 3 4
   ((void *)0)
# 181 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
...
{
    struct loop_timer *timer = 
# 196 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 3 4
                              ((void *)0)
# 196 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
                                  ;
    utils_dlist_t *tmp;
    int time2wait;
...
# 229 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 3 4
       ((void *)0)
# 229 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
...
# 307 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
}
...
{
    while (
# 316 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 3 4
          ((void *)0) 
# 316 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
               == loop->looper) {
        vTaskDelay(1);
    }
}
...
# 354 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c" 3 4
   ((void *)0) 
# 354 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/sys/bloop/bloop/src/bloop_base.c"
   );
}
