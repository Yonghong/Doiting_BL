# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/bl602_std//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
# 37 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_adc.h" 1
# 39 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_adc.h"
...
# 40 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_adc.h" 2
...
# 42 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_adc.h" 2
...
# 38 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c" 2
...
# 39 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c" 2
# 66 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
static intCallback_Type * adcIntCbfArra[ADC_INT_ALL]={
# 66 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c" 3 4
                                                     ((void *)0)
# 66 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
                                                         };
# 100 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Reset(void)
{
    uint32_t regCmd;
...
# 119 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Enable(void)
{
    uint32_t tmpVal;
...
# 136 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Disable(void)
{
    uint32_t tmpVal;
...
# 154 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Init(ADC_CFG_Type* cfg)
{
    uint32_t regCfg1;
    uint32_t regCfg2;
...
# 228 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Channel_Config(ADC_Chan_Type posCh,ADC_Chan_Type negCh,BL_Fun_Type contEn)
{
    uint32_t regCmd;
    uint32_t regCfg1;
...
# 261 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Scan_Channel_Config(ADC_Chan_Type posChList[],ADC_Chan_Type negChList[],uint8_t scanLength,BL_Fun_Type contEn)
{
    uint32_t tmpVal,i;
    uint32_t dealLen;
...
# 322 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Start(void)
{
    uint32_t regCmd;
...
# 348 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Stop(void)
{
    uint32_t regCmd;
...
# 366 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_FIFO_Cfg(ADC_FIFO_Cfg_Type *fifoCfg)
{
    uint32_t tmpVal;
...
# 401 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
uint8_t ADC_Get_FIFO_Count(void)
{
    uint32_t tmpVal;
...
# 418 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
BL_Sts_Type ADC_FIFO_Is_Full(void)
{
    uint32_t tmpVal;
...
# 439 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
BL_Sts_Type ADC_FIFO_Is_Empty(void)
{
    uint32_t tmpVal;
...
# 460 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
uint32_t ADC_Read_FIFO(void)
{
    uint32_t tmpVal;
...
# 479 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Parse_Result(uint32_t *orgVal,uint32_t len,ADC_Result_Type *result)
{
    uint8_t neg=0;
...
# 548 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_IntMask(ADC_INT_Type intType, BL_Mask_Type intMask)
{
    uint32_t tmpVal;
...
# 653 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_IntClr(ADC_INT_Type intType)
{
    uint32_t tmpVal;
...
# 782 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
BL_Sts_Type ADC_GetIntStatus(ADC_INT_Type intType)
{
    uint32_t tmpVal;
...
# 830 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Int_Callback_Install(ADC_INT_Type intType,intCallback_Type* cbFun)
{
...
# 893 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Vbat_Enable(void)
{
    uint32_t tmpVal;
...
# 910 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Vbat_Disable(void)
{
    uint32_t tmpVal;
...
# 927 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Tsen_Init(ADC_TSEN_MOD_Type tsenMod)
{
    uint32_t tmpVal;
...
# 983 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
...
# 1008 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_SET_TSVBE_LOW(void)
{
    uint32_t tmpVal;
    tmpVal=(*((volatile uint32_t*)(((uint32_t)0x4000F000)+(0x914))));
...
# 1024 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_SET_TSVBE_HIGH(void)
{
    uint32_t tmpVal;
    tmpVal=(*((volatile uint32_t*)(((uint32_t)0x4000F000)+(0x914))));
...
# 1040 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
float TSEN_Get_Temp(uint32_t tsen_offset)
{
    uint32_t v0 = 0, v1 = 0;
    float temp = 0;
...
# 1098 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
BL_Err_Type ADC_Mic_Init(ADC_MIC_Type * adc_mic_config)
{
    uint32_t tmpVal1=0,tmpVal2=0;
...
# 1145 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_MIC_Bias_Enable(void)
{
    uint32_t tmpVal;
...
# 1163 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_MIC_Bias_Disable(void)
{
    uint32_t tmpVal;
