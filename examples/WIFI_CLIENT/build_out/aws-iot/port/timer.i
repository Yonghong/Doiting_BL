# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/3rdparty/aws-iot/port/timer.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/aws-iot//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/3rdparty/aws-iot/port/timer.c"
# 25 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/3rdparty/aws-iot/port/timer.c"
...
# 26 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/3rdparty/aws-iot/port/timer.c" 2
...
# 27 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/3rdparty/aws-iot/port/timer.c" 2
...
# 41 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/3rdparty/aws-iot/aws-iot-device-sdk-embedded-C/include/timer_interface.h" 2
...
# 29 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/3rdparty/aws-iot/port/timer.c" 2
...
# 30 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/3rdparty/aws-iot/port/timer.c" 2
...
# 31 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/3rdparty/aws-iot/port/timer.c" 2
...
# 38 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/3rdparty/aws-iot/port/timer.c" 3 4
_Bool 
# 38 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/3rdparty/aws-iot/port/timer.c"
    has_timer_expired(Timer *timer)
{
    uint32_t now = xTaskGetTickCount();
    
# 41 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/3rdparty/aws-iot/port/timer.c" 3 4
   _Bool 
# 41 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/3rdparty/aws-iot/port/timer.c"
        expired = (now - timer->start_ticks) >= timer->timeout_ticks;
...
void countdown_ms(Timer *timer, uint32_t timeout)
{
    ...
    timer->timeout_ticks = timeout / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) );
...
uint32_t left_ms(Timer *timer)
{
    ...
    if (elapsed < timer->timeout_ticks) {
        return (timer->timeout_ticks - elapsed) * ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) );
    } else {
        return 0;
    }
}
...
{
    if (timeout > 0xffffffffUL / 1000) {
        puts(TAG);printf("ERROR" "timeout is out of range: %lus" "\r\n", timeout);
    }
