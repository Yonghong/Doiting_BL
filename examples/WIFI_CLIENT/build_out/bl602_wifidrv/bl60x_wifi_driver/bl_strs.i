# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_strs.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/bl602_wifidrv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_strs.c"
# 33 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_strs.c"
...
# 34 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_strs.c" 2


static const char *const bl_mmid2str[((MM_MAX) & ((1<<10)-1))] = {
    [((MM_RESET_REQ) & ((1<<10)-1))] = "MM_RESET_REQ",
    [((MM_RESET_CFM) & ((1<<10)-1))] = "MM_RESET_CFM",
    [((MM_START_REQ) & ((1<<10)-1))] = "MM_START_REQ",
    [((MM_START_CFM) & ((1<<10)-1))] = "MM_START_CFM",
    [((MM_VERSION_REQ) & ((1<<10)-1))] = "MM_VERSION_REQ",
    [((MM_VERSION_CFM) & ((1<<10)-1))] = "MM_VERSION_CFM",
    [((MM_ADD_IF_REQ) & ((1<<10)-1))] = "MM_ADD_IF_REQ",
    [((MM_ADD_IF_CFM) & ((1<<10)-1))] = "MM_ADD_IF_CFM",
    [((MM_REMOVE_IF_REQ) & ((1<<10)-1))] = "MM_REMOVE_IF_REQ",
    [((MM_REMOVE_IF_CFM) & ((1<<10)-1))] = "MM_REMOVE_IF_CFM",
    [((MM_STA_ADD_REQ) & ((1<<10)-1))] = "MM_STA_ADD_REQ",
    [((MM_STA_ADD_CFM) & ((1<<10)-1))] = "MM_STA_ADD_CFM",
    [((MM_STA_DEL_REQ) & ((1<<10)-1))] = "MM_STA_DEL_REQ",
    [((MM_STA_DEL_CFM) & ((1<<10)-1))] = "MM_STA_DEL_CFM",
    [((MM_SET_FILTER_REQ) & ((1<<10)-1))] = "MM_SET_FILTER_REQ",
    [((MM_SET_FILTER_CFM) & ((1<<10)-1))] = "MM_SET_FILTER_CFM",
    [((MM_SET_CHANNEL_REQ) & ((1<<10)-1))] = "MM_SET_CHANNEL_REQ",
    [((MM_SET_CHANNEL_CFM) & ((1<<10)-1))] = "MM_SET_CHANNEL_CFM",
    [((MM_SET_DTIM_REQ) & ((1<<10)-1))] = "MM_SET_DTIM_REQ",
    [((MM_SET_DTIM_CFM) & ((1<<10)-1))] = "MM_SET_DTIM_CFM",
    [((MM_SET_BEACON_INT_REQ) & ((1<<10)-1))] = "MM_SET_BEACON_INT_REQ",
    [((MM_SET_BEACON_INT_CFM) & ((1<<10)-1))] = "MM_SET_BEACON_INT_CFM",
    [((MM_SET_BASIC_RATES_REQ) & ((1<<10)-1))] = "MM_SET_BASIC_RATES_REQ",
    [((MM_SET_BASIC_RATES_CFM) & ((1<<10)-1))] = "MM_SET_BASIC_RATES_CFM",
    [((MM_SET_BSSID_REQ) & ((1<<10)-1))] = "MM_SET_BSSID_REQ",
    [((MM_SET_BSSID_CFM) & ((1<<10)-1))] = "MM_SET_BSSID_CFM",
    [((MM_SET_EDCA_REQ) & ((1<<10)-1))] = "MM_SET_EDCA_REQ",
    [((MM_SET_EDCA_CFM) & ((1<<10)-1))] = "MM_SET_EDCA_CFM",
    [((MM_SET_MODE_REQ) & ((1<<10)-1))] = "MM_SET_MODE_REQ",
    [((MM_SET_MODE_CFM) & ((1<<10)-1))] = "MM_SET_MODE_CFM",
    [((MM_SET_VIF_STATE_REQ) & ((1<<10)-1))] = "MM_SET_VIF_STATE_REQ",
    [((MM_SET_VIF_STATE_CFM) & ((1<<10)-1))] = "MM_SET_VIF_STATE_CFM",
    [((MM_SET_SLOTTIME_REQ) & ((1<<10)-1))] = "MM_SET_SLOTTIME_REQ",
    [((MM_SET_SLOTTIME_CFM) & ((1<<10)-1))] = "MM_SET_SLOTTIME_CFM",
    [((MM_SET_IDLE_REQ) & ((1<<10)-1))] = "MM_SET_IDLE_REQ",
    [((MM_SET_IDLE_CFM) & ((1<<10)-1))] = "MM_SET_IDLE_CFM",
    [((MM_KEY_ADD_REQ) & ((1<<10)-1))] = "MM_KEY_ADD_REQ",
    [((MM_KEY_ADD_CFM) & ((1<<10)-1))] = "MM_KEY_ADD_CFM",
    [((MM_KEY_DEL_REQ) & ((1<<10)-1))] = "MM_KEY_DEL_REQ",
    [((MM_KEY_DEL_CFM) & ((1<<10)-1))] = "MM_KEY_DEL_CFM",
    [((MM_BA_ADD_REQ) & ((1<<10)-1))] = "MM_BA_ADD_REQ",
    [((MM_BA_ADD_CFM) & ((1<<10)-1))] = "MM_BA_ADD_CFM",
    [((MM_BA_DEL_REQ) & ((1<<10)-1))] = "MM_BA_DEL_REQ",
    [((MM_BA_DEL_CFM) & ((1<<10)-1))] = "MM_BA_DEL_CFM",
    [((MM_PRIMARY_TBTT_IND) & ((1<<10)-1))] = "MM_PRIMARY_TBTT_IND",
    [((MM_SECONDARY_TBTT_IND) & ((1<<10)-1))] = "MM_SECONDARY_TBTT_IND",
    [((MM_SET_POWER_REQ) & ((1<<10)-1))] = "MM_SET_POWER_REQ",
    [((MM_SET_POWER_CFM) & ((1<<10)-1))] = "MM_SET_POWER_CFM",
    [((MM_DENOISE_REQ) & ((1<<10)-1))] = "MM_DENOISE_REQ",
    [((MM_SET_PS_MODE_REQ) & ((1<<10)-1))] = "MM_SET_PS_MODE_REQ",
    [((MM_SET_PS_MODE_CFM) & ((1<<10)-1))] = "MM_SET_PS_MODE_CFM",
    [((MM_CHAN_CTXT_ADD_REQ) & ((1<<10)-1))] = "MM_CHAN_CTXT_ADD_REQ",
    [((MM_CHAN_CTXT_ADD_CFM) & ((1<<10)-1))] = "MM_CHAN_CTXT_ADD_CFM",
    [((MM_CHAN_CTXT_DEL_REQ) & ((1<<10)-1))] = "MM_CHAN_CTXT_DEL_REQ",
    [((MM_CHAN_CTXT_DEL_CFM) & ((1<<10)-1))] = "MM_CHAN_CTXT_DEL_CFM",
    [((MM_CHAN_CTXT_LINK_REQ) & ((1<<10)-1))] = "MM_CHAN_CTXT_LINK_REQ",
    [((MM_CHAN_CTXT_LINK_CFM) & ((1<<10)-1))] = "MM_CHAN_CTXT_LINK_CFM",
    [((MM_CHAN_CTXT_UNLINK_REQ) & ((1<<10)-1))] = "MM_CHAN_CTXT_UNLINK_REQ",
    [((MM_CHAN_CTXT_UNLINK_CFM) & ((1<<10)-1))] = "MM_CHAN_CTXT_UNLINK_CFM",
    [((MM_CHAN_CTXT_UPDATE_REQ) & ((1<<10)-1))] = "MM_CHAN_CTXT_UPDATE_REQ",
    [((MM_CHAN_CTXT_UPDATE_CFM) & ((1<<10)-1))] = "MM_CHAN_CTXT_UPDATE_CFM",
    [((MM_CHAN_CTXT_SCHED_REQ) & ((1<<10)-1))] = "MM_CHAN_CTXT_SCHED_REQ",
    [((MM_CHAN_CTXT_SCHED_CFM) & ((1<<10)-1))] = "MM_CHAN_CTXT_SCHED_CFM",
    [((MM_BCN_CHANGE_REQ) & ((1<<10)-1))] = "MM_BCN_CHANGE_REQ",
    [((MM_BCN_CHANGE_CFM) & ((1<<10)-1))] = "MM_BCN_CHANGE_CFM",
    [((MM_TIM_UPDATE_REQ) & ((1<<10)-1))] = "MM_TIM_UPDATE_REQ",
    [((MM_TIM_UPDATE_CFM) & ((1<<10)-1))] = "MM_TIM_UPDATE_CFM",
    [((MM_CONNECTION_LOSS_IND) & ((1<<10)-1))] = "MM_CONNECTION_LOSS_IND",
    [((MM_CHANNEL_SWITCH_IND) & ((1<<10)-1))] = "MM_CHANNEL_SWITCH_IND",
    [((MM_CHANNEL_PRE_SWITCH_IND) & ((1<<10)-1))] = "MM_CHANNEL_PRE_SWITCH_IND",
    [((MM_REMAIN_ON_CHANNEL_REQ) & ((1<<10)-1))] = "MM_REMAIN_ON_CHANNEL_REQ",
    [((MM_REMAIN_ON_CHANNEL_CFM) & ((1<<10)-1))] = "MM_REMAIN_ON_CHANNEL_CFM",
    [((MM_REMAIN_ON_CHANNEL_EXP_IND) & ((1<<10)-1))] = "MM_REMAIN_ON_CHANNEL_EXP_IND",
    [((MM_PS_CHANGE_IND) & ((1<<10)-1))] = "MM_PS_CHANGE_IND",
    [((MM_TRAFFIC_REQ_IND) & ((1<<10)-1))] = "MM_TRAFFIC_REQ_IND",
    [((MM_SET_PS_OPTIONS_REQ) & ((1<<10)-1))] = "MM_SET_PS_OPTIONS_REQ",
    [((MM_SET_PS_OPTIONS_CFM) & ((1<<10)-1))] = "MM_SET_PS_OPTIONS_CFM",
    [((MM_P2P_VIF_PS_CHANGE_IND) & ((1<<10)-1))] = "MM_P2P_VIF_PS_CHANGE_IND",
    [((MM_CSA_COUNTER_IND) & ((1<<10)-1))] = "MM_CSA_COUNTER_IND",
    [((MM_CHANNEL_SURVEY_IND) & ((1<<10)-1))] = "MM_CHANNEL_SURVEY_IND",
    [((MM_SET_P2P_NOA_REQ) & ((1<<10)-1))] = "MM_SET_P2P_NOA_REQ",
    [((MM_SET_P2P_OPPPS_REQ) & ((1<<10)-1))] = "MM_SET_P2P_OPPPS_REQ",
    [((MM_SET_P2P_NOA_CFM) & ((1<<10)-1))] = "MM_SET_P2P_NOA_CFM",
    [((MM_SET_P2P_OPPPS_CFM) & ((1<<10)-1))] = "MM_SET_P2P_OPPPS_CFM",
    [((MM_CFG_RSSI_REQ) & ((1<<10)-1))] = "MM_CFG_RSSI_REQ",
    [((MM_RSSI_STATUS_IND) & ((1<<10)-1))] = "MM_RSSI_STATUS_IND",
    [((MM_CSA_FINISH_IND) & ((1<<10)-1))] = "MM_CSA_FINISH_IND",
    [((MM_CSA_TRAFFIC_IND) & ((1<<10)-1))] = "MM_CSA_TRAFFIC_IND",
    [((MM_MU_GROUP_UPDATE_REQ) & ((1<<10)-1))] = "MM_MU_GROUP_UPDATE_REQ",
    [((MM_MU_GROUP_UPDATE_CFM) & ((1<<10)-1))] = "MM_MU_GROUP_UPDATE_CFM",
};

static const char *const bl_dbgid2str[((DBG_MAX) & ((1<<10)-1))] = {
    [((DBG_MEM_READ_REQ) & ((1<<10)-1))] = "DBG_MEM_READ_REQ",
    [((DBG_MEM_READ_CFM) & ((1<<10)-1))] = "DBG_MEM_READ_CFM",
    [((DBG_MEM_WRITE_REQ) & ((1<<10)-1))] = "DBG_MEM_WRITE_REQ",
    [((DBG_MEM_WRITE_CFM) & ((1<<10)-1))] = "DBG_MEM_WRITE_CFM",
    [((DBG_SET_MOD_FILTER_REQ) & ((1<<10)-1))] = "DBG_SET_MOD_FILTER_REQ",
    [((DBG_SET_MOD_FILTER_CFM) & ((1<<10)-1))] = "DBG_SET_MOD_FILTER_CFM",
    [((DBG_SET_SEV_FILTER_REQ) & ((1<<10)-1))] = "DBG_SET_SEV_FILTER_REQ",
    [((DBG_SET_SEV_FILTER_CFM) & ((1<<10)-1))] = "DBG_SET_SEV_FILTER_CFM",
    [((DBG_ERROR_IND) & ((1<<10)-1))] = "DBG_ERROR_IND",
    [((DBG_GET_SYS_STAT_REQ) & ((1<<10)-1))] = "DBG_GET_SYS_STAT_REQ",
    [((DBG_GET_SYS_STAT_CFM) & ((1<<10)-1))] = "DBG_GET_SYS_STAT_CFM",
};

static const char *const bl_scanid2str[((SCAN_MAX) & ((1<<10)-1))] = {
    [((SCAN_START_REQ) & ((1<<10)-1))] = "SCAN_START_REQ",
    [((SCAN_START_CFM) & ((1<<10)-1))] = "SCAN_START_CFM",
    [((SCAN_DONE_IND) & ((1<<10)-1))] = "SCAN_DONE_IND",
};

static const char *const bl_tdlsid2str[((TDLS_MAX) & ((1<<10)-1))] = {
    [((TDLS_CHAN_SWITCH_CFM) & ((1<<10)-1))] = "TDLS_CHAN_SWITCH_CFM",
    [((TDLS_CHAN_SWITCH_REQ) & ((1<<10)-1))] = "TDLS_CHAN_SWITCH_REQ",
    [((TDLS_CHAN_SWITCH_IND) & ((1<<10)-1))] = "TDLS_CHAN_SWITCH_IND",
    [((TDLS_CHAN_SWITCH_BASE_IND) & ((1<<10)-1))] = "TDLS_CHAN_SWITCH_BASE_IND",
};
# 233 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_strs.c"
