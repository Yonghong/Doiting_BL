# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/bl602_wifidrv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
# 31 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
...
# 32 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 2
...
# 33 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 2
...
# 45 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/include/lwip/etharp.h"
...
# 46 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/include/lwip/etharp.h" 2
...
# 50 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/include/lwip/etharp.h" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/include/lwip/ip4_addr.h" 1
# 41 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/include/lwip/ip4_addr.h"
...
# 42 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/include/lwip/ip4_addr.h" 2
...
# 3 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/include/netif/etharp.h" 2
# 34 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 2
...
# 37 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.h" 2
...
# 38 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.h" 2
...
void bl_irq_handler();
# 36 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 2
...
# 37 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 2
...
# 45 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 3 4
                                ((void *)0)
# 45 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
                                    ;
...
void bl_tx_push(struct bl_hw *bl_hw, struct bl_txhdr *txhdr)
{
    ...
    do { if (!(host)) { printf("%d:ASSERT_ERR(" "host" ")\n", 55); } } while(0);
...
void bl_tx_resend()
{
    ...
    while (txhdr_pos_r != txhdr_pos_w) {
        if (
# 81 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 3 4
           ((void *)0) 
# 81 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
                == ipc_host_txdesc_get(bl_hw_static->ipc_env)) {
            break;
        }
        txhdr_hodler[txhdr_pos_r & (0x7)]->status.value = 0;



        bl_tx_push(bl_hw_static, txhdr_hodler[txhdr_pos_r & (0x7)]);
        txhdr_pos_r++;
    }
    vTaskExitCritical();
}
...
void bl_tx_try_flush()
{
    ...
    while (ipc_host_txdesc_get(bl_hw_static->ipc_env)) {
        ...
        if (
# 101 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 3 4
           ((void *)0) 
# 101 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
                == txhdr) {
            break;
        }
...
int bl_txdatacfm(void *pthis, void *host_id)
{
    ...
    if (bl_txst.value & (1 << 16)) {





        if (((txhdr_pos_w + 1) & (0x7)) != (txhdr_pos_r & (0x7))) {

            puts(" push back\r\n");

            txhdr_hodler[txhdr_pos_w & (0x7)] = txhdr;
            txhdr_pos_w++;
        } else {
...
void bl_tx_notify()
{
    ...
    if (taskHandle_output) {
        xTaskGenericNotify( ( taskHandle_output ), ( 0 ), eIncrement, 
# 154 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 3 4
       ((void *)0) 
# 154 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
       );
    }
...
err_t bl_output(struct bl_hw *bl_hw, struct netif *netif, struct pbuf *p, int is_sta)
{
    ...
    if (
# 172 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 3 4
       ((void *)0) 
# 172 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
            == bl_hw || 0 == (0x04U & netif->flags)) {
    ...
    if (pbuf_header(p, 128u)) {
        printf("[TX] Reserve room failed for header\r\n");
        return ERR_IF;
    }

    link_header = (uint32_t*)(((uint32_t)p->payload) + ((4 - (((uint32_t)p->payload) & (4 - 1))) & (4 - 1)));
    if (16 + sizeof(struct bl_txhdr) + ((4 - (((uint32_t)p->payload) & (4 - 1))) & (4 - 1)) > 128u) {
        printf("link_header size is %ld vs header %u\r\n",
                sizeof(struct bl_txhdr) + ((4 - (((uint32_t)p->payload) & (4 - 1))) & (4 - 1)),
                128u
        );
    }
    ...
    memcpy(&host->eth_dest_addr, eth->h_dest, 6);
    memcpy(&host->eth_src_addr, eth->h_source, 6);
    ...
    loop = 0;
    for (q = p; q != 
# 223 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c" 3 4
                    ((void *)0)
# 223 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
                        ; q = q->next) {
        if (0 == loop) {

            host->pbuf_chained_ptr[loop] = (uint32_t)(((uint8_t*)q->payload) + sizeof(*eth)) + 128u;
            host->pbuf_chained_len[loop] = q->len - sizeof(*eth) - 128u;
        } else {
...
# 250 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_wifidrv/bl60x_wifi_driver/bl_tx.c"
        }
        loop++;
    }
    if (loop > 2) {
    ...
    host->packet_addr = (uint32_t)(0x11111111);
