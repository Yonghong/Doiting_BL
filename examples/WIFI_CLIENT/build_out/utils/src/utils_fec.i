# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/utils//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c"
# 32 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c"
...
# 33 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c" 2
...
# 34 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c" 2
...
# 35 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c" 2
...
# 38 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c" 2
# 46 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c"
typedef struct {
    uint8_t _id;
    uint8_t _size;
    uint16_t _offset;
...
uint8_t find_error_locator(fec_context_t *context, blpoly_t *synd, blpoly_t *erase_loc, unsigned long erase_count)
{
    ...
    if (erase_loc != 
# 535 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c" 3 4
                    ((void *)0)
# 535 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c"
                        ) {
    ...
    {
        if (erase_loc != 
# 552 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c" 3 4
                        ((void *)0)
# 552 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c"
                            ) {
...
char decode_block(fec_context_t *context, void* src, const void* ecc, void* dst, uint8_t* erase_pos, unsigned long erase_count)
{
    ...
    if (erase_pos == 
# 774 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c" 3 4
                    ((void *)0)
# 774 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c"
                        ) {
        epos->length = 0;
    } else {
...
# 805 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c" 3 4
                                       ((void *)0)
# 805 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/utils/src/utils_fec.c"
                                           , epos->length);
