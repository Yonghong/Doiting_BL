# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/netutils//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
# 30 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
...
# 31 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 2
...
# 32 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 2
...
# 33 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 2
...
# 34 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 2
...
# 35 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 2
...
# 512 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 36 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 2
...
# 37 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 2
...
# 38 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 2
...
void TCP_Server(void *pvParameters)
{
    ...
    int time_cur, time_diff[(5)], time_last[(5)];
    
# 53 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
   _types_fd_set 
# 53 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
          fdsr;
    int maxsock;
    struct timeval tv;
    int client_fd[(5)];
    ...
    data_buffer = pvPortMalloc((10 * 1024));
    memset(data_buffer, 0, (10 * 1024));
    ...
    if ((listening_socket = lwip_socket(2,1,6) < 0)) {
        printf("socket creat failed\r\n");
        vPortFree(data_buffer);
        vTaskDelete(
# 71 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3 4
                   ((void *)0)
# 71 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
                       );
    } else {
        printf("socket:%d\r\n", listening_socket);
    }
    if (lwip_setsockopt(listening_socket,0xfff,0x0004,&yes,sizeof(int)) == -1) {
        printf("setsockopt failed\r\n");
        goto Failed;
    }

    server_addr.sin_family = 2;
    server_addr.sin_port = lwip_htons((5150));
    server_addr.sin_addr.s_addr = lwip_htonl(((u32_t)0x00000000UL));

    if ((lwip_bind(listening_socket,(struct sockaddr *)&server_addr,sizeof(struct sockaddr)) < 0)) {
        printf("bind failed\r\n");
        goto Failed;
    }

    if (lwip_listen(listening_socket,(5)) < 0) {
...
# 107 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
       (__extension__ (void)({ size_t __i; char *__tmp = (char *)
# 107 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
       &fdsr
# 107 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
...
# 108 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
       ((
# 108 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
       &fdsr
# 108 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
       )->fds_bits[(
# 108 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
...
# 114 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
               ((
# 114 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
               &fdsr
# 114 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
               )->fds_bits[(
# 114 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
...
# 114 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
                ...
                if (time_diff[i] >= ( ( TickType_t ) 1000 )) {
                    time_last[i] = time_cur;
                    connect_time[i]--;
                    if (connect_time[i] <= 0) {
                        lwip_close(client_fd[i]);
                        connect_time[i] = atoi((char *)pvParameters);
                        
# 123 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
                       ((
# 123 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
                       &fdsr
# 123 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
                       )->fds_bits[(
# 123 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
...
# 123 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
        ...
        ret = lwip_select(maxsock + 1,&fdsr,
# 131 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3 4
             ((void *)0)
# 131 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
             ,
# 131 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3 4
             ((void *)0)
# 131 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
        ...
        for (i = 0; i < (5); i++) {
            if (client_fd[i] != listening_socket) {
                if (
# 141 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
                   ((
# 141 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
                   &fdsr
# 141 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
                   )->fds_bits[(
# 141 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
...
# 141 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
                    ...
                    time_cur = xTaskGetTickCount();
                    memset(data_buffer, 0, (10 * 1024));
                    if((ret = lwip_recv(client_fd[i],data_buffer,(10 * 1024),0)) <= 0) {
                        printf("recv failed:%d\r\n", ret);
                        lwip_close(client_fd[i]);
                        connect_time[i] = atoi((char *)pvParameters);
                        
# 148 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
                       ((
# 148 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
                       &fdsr
# 148 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
                       )->fds_bits[(
# 148 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
...
# 148 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
                        ...
                        printf("%s\r\n", data_buffer);
                        if ((ret = lwip_send(client_fd[i],data_buffer,ret,0)) <= 0 ) {
                            printf("send failed\r\n");
                            lwip_close(client_fd[i]);
                            connect_time[i] = atoi((char *)pvParameters);
                            
# 161 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
                           ((
# 161 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
                           &fdsr
# 161 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
                           )->fds_bits[(
# 161 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
...
# 161 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
        ...
        if (
# 173 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
           ((
# 173 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
           &fdsr
# 173 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3
           )->fds_bits[(
# 173 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
...
# 173 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
            ...
            if ((new_connection = lwip_accept(listening_socket,(struct sockaddr *)&client_addr,&client_addrlen)) <= 0) {
            ...
            if (con_amount < (5)) {
                ...
                lwip_send(new_connection,"Bye",4,0);
                lwip_close(new_connection);
            }
        }
    }
...
Failed:
    ...
    vTaskDelete(
# 210 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3 4
               ((void *)0)
# 210 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
                   );
}
...
static void cmd_tcp_server(char *buf, int len, int argc, char **argv)
{
    ...
    xTaskCreate(TCP_Server, "TCP Server", 1024, argv[1], 20, 
# 219 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c" 3 4
                                                            ((void *)0)
# 219 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/netutils/tcpserver/tcpserver.c"
                                                                );
}
