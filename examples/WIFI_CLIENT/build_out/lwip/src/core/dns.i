# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
# 87 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
...
# 88 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 2
...
# 92 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 2
...
# 93 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                   dns_found_callback found, void *callback_arg,
                                   u8_t dns_addrtype);
# 96 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/include/lwip/prot/dns.h" 1
# 101 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/include/lwip/prot/dns.h"
...
# 97 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 2
...
# 99 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 2
...
# 105 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
static u16_t dns_txid;
# 189 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
struct dns_query {
...
# 285 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
...
static struct udp_pcb *dns_pcbs[1];
...
const ip_addr_t dns_mquery_v4group = { (((((((u32_t)((224) & 0xff) << 24) | ((u32_t)((0) & 0xff) << 16) | ((u32_t)((0) & 0xff) << 8) | (u32_t)((251) & 0xff))) & (u32_t)0x000000ffUL) << 24) | ((((((u32_t)((224) & 0xff) << 24) | ((u32_t)((0) & 0xff) << 16) | ((u32_t)((0) & 0xff) << 8) | (u32_t)((251) & 0xff))) & (u32_t)0x0000ff00UL) << 8) | ((((((u32_t)((224) & 0xff) << 24) | ((u32_t)((0) & 0xff) << 16) | ((u32_t)((0) & 0xff) << 8) | (u32_t)((251) & 0xff))) & (u32_t)0x00ff0000UL) >> 8) | ((((((u32_t)((224) & 0xff) << 24) | ((u32_t)((0) & 0xff) << 16) | ((u32_t)((0) & 0xff) << 8) | (u32_t)((251) & 0xff))) & (u32_t)0xff000000UL) >> 24)) };
# 314 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
void
dns_init(void)
{
  ...
  if (dns_pcbs[0] == 
# 333 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                    ((void *)0)
# 333 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                        ) {
    dns_pcbs[0] = udp_new_ip_type(IPADDR_TYPE_ANY);
    do { if (!(dns_pcbs[0] != 
# 335 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
   ((void *)0)
# 335 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
   )) { ; }} while(0);



    do { if (!(DNS_STATE_UNUSED == 0)) { ; }} while(0)
                                      ;


    udp_bind(dns_pcbs[0], (&ip_addr_any), 0);
    udp_recv(dns_pcbs[0], dns_recv, 
# 344 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                                   ((void *)0)
# 344 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                                       );
  }
...
# 360 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
void
dns_setserver(u8_t numdns, const ip_addr_t *dnsserver)
{
  if (numdns < 2) {
    if (dnsserver != 
# 364 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                    ((void *)0)
# 364 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                        ) {
...
# 380 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
const ip_addr_t *
...
# 601 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
static err_t
dns_lookup(const char *name, ip_addr_t *addr )
{
  u8_t i;
# 617 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
  for (i = 0; i < 4; ++i) {
...
# 650 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
static u16_t
  ...
  do {
    ...
    if ((n & 0xc0) == 0xc0) {
      ...
      while (n > 0) {
        ...
        if (
# 674 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3
           __extension__ ({ __typeof__ (
# 674 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
           (unsigned char)((*query))
# 674 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3
           ) __x = (
# 674 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
...
# 707 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
static u16_t
...
dns_send(u8_t idx)
{
  ...
  if (((dns_servers[entry->server_idx]).addr == ((u32_t)0x00000000UL))
    ...
    dns_call_found(idx, 
# 770 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                       ((void *)0)
# 770 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                           );
  ...
  p = pbuf_alloc(PBUF_TRANSPORT, (u16_t)(12 + strlen(entry->name) + 2 +
                                         4), PBUF_RAM);
  if (p != 
# 779 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
          ((void *)0)
# 779 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
              ) {
    const ip_addr_t *dst;
    u16_t dst_port;
    ...
    pcb_idx = 0;
                                                                         ...
                                                                         ;
# 846 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
    {
      dst_port = 53;
...
# 941 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
static void
dns_call_found(u8_t idx, ip_addr_t *addr)
{
# 970 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
  if (dns_requests[idx].found) {
    (*dns_requests[idx].found)(dns_table[idx].name, addr, dns_requests[idx].arg);
  }
  dns_requests[idx].found = 
# 973 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                           ((void *)0)
# 973 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                               ;
# 996 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
}
...
dns_backupserver_available(struct dns_table_entry *pentry)
{
  ...
  if (pentry) {
    if ((pentry->server_idx + 1 < 2) && !((dns_servers[pentry->server_idx + 1]).addr == ((u32_t)0x00000000UL))) {
      ret = 1;
    }
  }
...
# 1046 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
static void
      ...
      if (--entry->tmr == 0) {
        if (++entry->retries == 4) {
          if (dns_backupserver_available(entry)
            ...
            dns_call_found(i, 
# 1085 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                             ((void *)0)
# 1085 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                                 );
    ...
    for (i = 0; i < 4; i++) {
      ...
      if ((entry->state == DNS_STATE_ASKING) &&
        ...
        if ((qry.cls != ((u16_t)((((1) & (u16_t)0x00ffU) << 8) | (((1) & (u16_t)0xff00U) >> 8)))) ||
            (0 && (qry.type != ((u16_t)((((28) & (u16_t)0x00ffU) << 8) | (((28) & (u16_t)0xff00U) >> 8))))) ||
            (!0 && (qry.type != ((u16_t)((((1) & (u16_t)0x00ffU) << 8) | (((1) & (u16_t)0xff00U) >> 8)))))) {
          ;
          goto ignore_packet;
        }
        ...
        if (hdr.flags2 & 0x0f) {
          ...
          while ((nanswers > 0) && (res_idx < p->tot_len)) {
            ...
            if (ans.cls == ((u16_t)((((1) & (u16_t)0x00ffU) << 8) | (((1) & (u16_t)0xff00U) >> 8)))) {
...
# 1324 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
            }
...
# 1348 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
          ;
        }

        pbuf_free(p);
        dns_call_found(i, 
# 1352 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                         ((void *)0)
# 1352 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                             );
...
# 1374 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
static err_t
...
# 1380 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                                 ((void *)0)
# 1380 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                                     ;
  size_t namelen;
  struct dns_req_entry *req;
# 1415 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
  lseq = 0;
  lseqi = 4;
  for (i = 0; i < 4; ++i) {
    entry = &dns_table[i];
...
# 1463 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
  req = &dns_requests[i];
...
# 1496 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
  dns_seqno++;
...
# 1525 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
err_t
...
# 1546 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
err_t
                           ...
                           void *callback_arg, u8_t dns_addrtype)
{
  ...
  if ((addr == 
# 1556 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
              ((void *)0)
# 1556 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                  ) ||
      (!hostname) || (!hostname[0])) {
    return ERR_ARG;
  }
  ...
  if (dns_pcbs[0] == 
# 1561 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c" 3 4
                    ((void *)0)
# 1561 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
                        ) {
    return ERR_ARG;
  }
...
# 1580 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
...
# 1607 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
  (void)dns_addrtype;
# 1619 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/dns.c"
  {
