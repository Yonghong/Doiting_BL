# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
# 42 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
...
# 43 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 2



# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/include/lwip/icmp.h" 1
# 41 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/include/lwip/icmp.h"
...
# 42 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/include/lwip/icmp.h" 2
...
# 43 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/include/lwip/icmp.h" 2
...
# 44 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/include/lwip/icmp.h" 2
...
# 47 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 2
...
# 48 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 2
...
# 49 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 2
...
# 53 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 2
# 68 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"

# 68 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
static void icmp_send_response(struct pbuf *p, u8_t type, u8_t code);
# 79 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
void
icmp_input(struct pbuf *p, struct netif *inp)
{
  ...
  switch (type) {
    ...
    case 8:
      ...
      if (pbuf_add_header(p, hlen + (14 + 0) + 128u)) {
        ...
        if (r == 
# 169 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 3 4
                ((void *)0)
# 169 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
                    ) {
          ;
          goto icmperr;
        }
        ...
        if (pbuf_remove_header(p, hlen + (14 + 0) + 128u)) {
          do { if (!(0)) { ; }} while(0);
          goto icmperr;
        }
      }
      ...
      if (pbuf_add_header(p, hlen)) {
...

        {
          ...
          if (iecho->chksum > ((u16_t)((((0xffffU - (8 << 8)) & (u16_t)0x00ffU) << 8) | (((0xffffU - (8 << 8)) & (u16_t)0xff00U) >> 8)))) {
            iecho->chksum = (u16_t)(iecho->chksum + ((u16_t)(((((u16_t)(8 << 8)) & (u16_t)0x00ffU) << 8) | ((((u16_t)(8 << 8)) & (u16_t)0xff00U) >> 8))) + 1);
          } else {
            iecho->chksum = (u16_t)(iecho->chksum + ((u16_t)((((8 << 8) & (u16_t)0x00ffU) << 8) | (((8 << 8) & (u16_t)0xff00U) >> 8))));
          }
        }
# 235 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
        (iphdr)->_ttl = (u8_t)(255);
        (iphdr)->_chksum = (0);
...
# 250 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 3 4
                                   ((void *)0)
# 250 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
                                                  ,
                            255, 0, 1, inp);
        if (ret != ERR_OK) {
          ;
...
# 307 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
void
...
# 339 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
static void
icmp_send_response(struct pbuf *p, u8_t type, u8_t code)
{
  ...
  q = pbuf_alloc(PBUF_IP, sizeof(struct icmp_echo_hdr) + 20 + 8,
                 PBUF_RAM);
  if (q == 
# 355 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 3 4
          ((void *)0)
# 355 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
              ) {
    ;
    ;
    return;
  ...
  if (netif != 
# 390 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 3 4
              ((void *)0)
# 390 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
                  ) {
    ...
    ++lwip_stats.icmp.xmit;
    ip4_output_if(q, 
# 399 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c" 3 4
                    ((void *)0)
# 399 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/ipv4/icmp.c"
