# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c"
# 39 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c"
...
# 40 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c" 2
...
# 44 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c" 2
...
# 45 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c" 2
...
# 49 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c" 2
...
# 52 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c" 2
...
# 55 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c" 2
...
# 58 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c" 2


# 59 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c"
...
# 178 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c"
void
stats_netstat(void *ctx)
{
  ...
  struct tcp_pcb **const*_tcp_pcb_list = 
# 187 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c" 3 4
                                        ((void *)0)
# 187 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c"
                                            ;
  struct tcp_pcb *curr_tcp = 
# 188 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c" 3 4
                            ((void *)0)
# 188 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c"
                                ;
  int tcp_pcb_num = tcp_get_pcbs(&_tcp_pcb_list);


  struct udp_pcb *_udp_pcbs = udp_get_pcbs();
  struct udp_pcb *curr_udp = 
# 193 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c" 3 4
                            ((void *)0)
# 193 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c"
                                ;


  struct raw_pcb *_raw_pcbs = raw_get_pcbs();
  struct raw_pcb *curr_raw = 
# 197 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c" 3 4
                            ((void *)0)
# 197 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c"
                                ;

  do {printf ("netstat tools\r\n");} while(0);
  ...
  for (i=0; i<tcp_pcb_num; i++) {
    ...
    for (curr_tcp = *_tcp_pcb_list[i]; curr_tcp != 
# 206 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c" 3 4
                                                  ((void *)0)
# 206 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c"
                                                      ; curr_tcp = curr_tcp->next) {
      ip4addr_ntoa_r(&curr_tcp->local_ip, ip_str, sizeof ip_str);
      do {printf ("TCP\t%s:%""u""\t", ip_str, curr_tcp->local_port);} while(0);

      ip4addr_ntoa_r(&curr_tcp->remote_ip, ip_str, sizeof ip_str);
      do {printf ("%s:%""u""\t%s\r\n", ip_str, curr_tcp->remote_port, tcp_debug_state_str(curr_tcp->state));} while(0)
                                                  ;
    }
  }
  ...
  for (curr_udp = _udp_pcbs; curr_udp != 
# 219 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c" 3 4
                                        ((void *)0)
# 219 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c"
                                            ; curr_udp = curr_udp->next) {
    ip4addr_ntoa_r(&curr_udp->local_ip, ip_str, sizeof ip_str);
    do {printf ("UDP\t%s:%""u""\t", ip_str, curr_udp->local_port);} while(0);

    ip4addr_ntoa_r(&curr_udp->remote_ip, ip_str, sizeof ip_str);
    do {printf ("%s:%""u""\r\n", ip_str, curr_udp->remote_port);} while(0);
  }




  for (curr_raw = _raw_pcbs; curr_raw != 
# 230 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c" 3 4
                                        ((void *)0)
# 230 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/stats.c"
                                            ; curr_raw = curr_raw->next) {
    ip4addr_ntoa_r(&curr_raw->local_ip, ip_str, sizeof ip_str);
    do {printf ("RAW\t%s\t", ip_str);} while(0);

    ip4addr_ntoa_r(&curr_raw->remote_ip, ip_str, sizeof ip_str);
    do {printf ("%s\t%d\r\n", ip_str, curr_raw->protocol);} while(0);
  }
