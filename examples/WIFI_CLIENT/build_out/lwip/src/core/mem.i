# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
# 56 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
...
# 57 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c" 2
...
# 58 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c" 2
...
# 59 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c" 2
...
# 60 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c" 2
...
# 61 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c" 2
...
# 64 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c" 2
# 349 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
...
# 379 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
u8_t ram_heap[(((((((8*1024)) + 4 - 1U) & ~(4 -1U)) + (2U * (((sizeof(struct mem)) + 4 - 1U) & ~(4 -1U)))) + 4 - 1U))] __attribute__((section(".wifi_ram")));
...
# 421 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
static struct mem * lfree;
# 450 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
static struct mem *
...
# 473 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
static void
plug_holes(struct mem *mem)
{
  ...
  do { if (!(mem->next <= ((((8*1024)) + 4 - 1U) & ~(4 -1U)))) { ; }} while(0);
...
mem_init(void)
{
  ...
  mem->next = ((((8*1024)) + 4 - 1U) & ~(4 -1U));
  mem->prev = 0;
  mem->used = 0;

  ram_end = ptr_to_mem(((((8*1024)) + 4 - 1U) & ~(4 -1U)));
  ram_end->used = 1;
  ram_end->next = ((((8*1024)) + 4 - 1U) & ~(4 -1U));
  ram_end->prev = ((((8*1024)) + 4 - 1U) & ~(4 -1U));
  ;


  lfree = (struct mem *)(void *)ram;

  lwip_stats.mem.avail = ((((8*1024)) + 4 - 1U) & ~(4 -1U));
...
mem_link_valid(struct mem *mem)
{
  ...
  nmem = ptr_to_mem(mem->next);
  pmem = ptr_to_mem(mem->prev);
  if ((mem->next > ((((8*1024)) + 4 - 1U) & ~(4 -1U))) || (mem->prev > ((((8*1024)) + 4 - 1U) & ~(4 -1U))) ||
...
# 616 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
void
mem_free(void *rmem)
{
  struct mem *mem;
  ...
  if (rmem == 
# 622 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c" 3 4
             ((void *)0)
# 622 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
                 ) {
    ;
    return;
  }
  if ((((mem_ptr_t)rmem) & (4 - 1)) != 0) {
    ...
    do { sys_prot_t old_level; old_level = sys_arch_protect(); ++lwip_stats.mem.illegal; sys_arch_unprotect(old_level); } while(0);
    return;
  }
  ...
  lwip_stats.mem.used = (mem_size_t)((lwip_stats.mem.used) - (mem->next - (mem_size_t)(((u8_t *)mem - ram))));
...
# 698 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
void *
mem_trim(void *rmem, mem_size_t new_size)
{
  ...
  if ((newsize > ((((8*1024)) + 4 - 1U) & ~(4 -1U))) || (newsize < new_size)) {
    return 
# 718 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c" 3 4
          ((void *)0)
# 718 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
              ;
  }
  ...
  if (newsize > size) {
    ...
    return 
# 743 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c" 3 4
          ((void *)0)
# 743 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
              ;
  }
  if (newsize == size) {
  ...
  if (mem2->used == 0) {
    ...
    if (mem2->next != ((((8*1024)) + 4 - 1U) & ~(4 -1U))) {
      ptr_to_mem(mem2->next)->prev = ptr2;
    }
    lwip_stats.mem.used = (mem_size_t)((lwip_stats.mem.used) - ((size - newsize)));
...
# 814 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
  ;
...
# 830 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
void *
mem_malloc(mem_size_t size_in)
{
  ...
  if (size_in == 0) {
    return 
# 841 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c" 3 4
          ((void *)0)
# 841 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
              ;
  }
  ...
  if ((size > ((((8*1024)) + 4 - 1U) & ~(4 -1U))) || (size < size_in)) {
    return 
# 855 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c" 3 4
          ((void *)0)
# 855 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
              ;
  }
  ...
  sys_mutex_lock(&mem_mutex);
  ;
# 870 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
    for (ptr = mem_to_ptr(lfree); ptr < ((((8*1024)) + 4 - 1U) & ~(4 -1U)) - size;
         ptr = ptr_to_mem(ptr)->next) {
      mem = ptr_to_mem(ptr);
# 886 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
      if ((!mem->used) &&
...
# 902 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
          ptr2 = (mem_size_t)(ptr + (((sizeof(struct mem)) + 4 - 1U) & ~(4 -1U)) + size);
          do { if (!(ptr2 != ((((8*1024)) + 4 - 1U) & ~(4 -1U)))) { ; }} while(0);
          ...
          do { lwip_stats.mem.used = (mem_size_t)(lwip_stats.mem.used + (size + (((sizeof(struct mem)) + 4 - 1U) & ~(4 -1U)))); if (lwip_stats.mem.max < lwip_stats.mem.used) { lwip_stats.mem.max = lwip_stats.mem.used; } } while(0);
        } else {
          ...
          mem->used = 1;
          do { lwip_stats.mem.used = (mem_size_t)(lwip_stats.mem.used + mem->next - mem_to_ptr(mem)); if (lwip_stats.mem.max < lwip_stats.mem.used) { lwip_stats.mem.max = lwip_stats.mem.used; } } while(0);
        }
...
# 946 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
  ...
  ;
  return 
# 975 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c" 3 4
        ((void *)0)
# 975 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
            ;
}
# 998 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
void *
mem_calloc(mem_size_t count, mem_size_t size)
{
  ...
  if ((size_t)(mem_size_t)alloc_size != alloc_size) {
    ;
    return 
# 1006 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c" 3 4
          ((void *)0)
# 1006 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/src/core/mem.c"
              ;
  }
