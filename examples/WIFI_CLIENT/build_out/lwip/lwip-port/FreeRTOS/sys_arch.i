# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
# 34 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
...
# 35 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 2
...
# 36 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 2
...
# 37 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 2
...
# 38 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 2
...
# 39 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 2
 ...
 *mbox = xQueueGenericCreate( ( 50 ), ( sizeof( void * ) ), ( ( ( uint8_t ) 0U ) ) );
 ...
 if (*mbox == 
# 66 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
             ((void *)0)
# 66 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
                 )
  return ERR_MEM;
...
# 145 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
u32_t sys_arch_mbox_fetch(sys_mbox_t *mbox, void **msg, u32_t timeout)
{
void *dummyptr;
TickType_t StartTime, EndTime, Elapsed;
 ...
 if ( msg == 
# 152 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
            ((void *)0) 
# 152 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
                 )
 {
  msg = &dummyptr;
 }
 ...
 if ( timeout != 0 )
 {
  if ( ( ( BaseType_t ) 1 ) == xQueueReceive( *mbox, &(*msg), timeout / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ) ) )
  {
  ...
  {
   *msg = 
# 168 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
         ((void *)0)
# 168 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
             ;
 ...
 {
  while( ( ( BaseType_t ) 1 ) != xQueueReceive( *mbox, &(*msg), ( TickType_t ) 0xffffffffUL ) ){}
  EndTime = xTaskGetTickCount();
  Elapsed = (EndTime - StartTime) * ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) );
...
void *dummyptr;
 ...
 if ( msg == 
# 192 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
            ((void *)0) 
# 192 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
                 )
 {
  msg = &dummyptr;
 }

   if ( ( ( BaseType_t ) 1 ) == xQueueReceive( *mbox, &(*msg), 0 ) )
   {
      return ERR_OK;
   }
   else
...
# 225 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
((void *)0) 
# 225 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
...
, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ); } };
 if(*sem == 
# 226 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
           ((void *)0)
# 226 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
               )
 {
...
# 265 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
u32_t sys_arch_sem_wait(sys_sem_t *sem, u32_t timeout)
{
TickType_t StartTime, EndTime, Elapsed;
 ...
 if( timeout != 0)
 {
  if( xQueueSemaphoreTake( ( *sem ), ( timeout / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ) ) ) == ( ( BaseType_t ) 1 ) )
  {
   EndTime = xTaskGetTickCount();
   Elapsed = (EndTime - StartTime) * ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) );
 ...
 {
  while( xQueueSemaphoreTake( ( *sem ), ( ( TickType_t ) 0xffffffffUL ) ) != ( ( BaseType_t ) 1 )){}
  EndTime = xTaskGetTickCount();
  Elapsed = (EndTime - StartTime) * ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) );
...
# 300 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
((void *)0)
# 300 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
}
...
err_t sys_mutex_new(sys_mutex_t *mutex) {
  ...
  *mutex = xQueueCreateMutex( ( ( uint8_t ) 1U ) );
  if(*mutex == 
# 344 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
              ((void *)0)
# 344 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
                  )
 {
...
# 381 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
((void *)0)
# 381 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
}
# 393 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
sys_thread_t sys_thread_new(const char *name, lwip_thread_fn thread , void *arg, int stacksize, int prio)
{
...
int result;
   ...
   if ( s_nextthread < 6 )
   {
    ...
    {
     return 
# 412 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
           ((void *)0)
# 412 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
               ;
    }
   }
   else
   {
      return 
# 417 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 3 4
            ((void *)0)
# 417 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
                ;
   }
}
# 434 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
sys_prot_t sys_arch_protect(void)
{
 vTaskEnterCritical();
 return 1;
...
u32_t sys_now(void)
{
    ...
    return xTaskGetTickCount() / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) );
}
