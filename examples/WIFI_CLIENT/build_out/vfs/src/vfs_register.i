# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c"
...
# 6 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c" 2
...
# 7 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c" 2
...
# 8 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/include/vfs_conf.h" 1
# 9 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c" 2
...
# 10 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c" 2
...
# 11 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c" 2
...
{
    inode_t *node = 
# 16 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c" 3 4
                   ((void *)0)
# 16 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c"
                       ;
    int err, ret;
...
# 34 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c" 3 4
                 ((void *)0)
# 34 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c"
                 , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) )) {
        err = -1;
        if (node->i_name != 
# 36 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c" 3 4
                           ((void *)0)
# 36 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c"
                               ) {
...
int aos_unregister_driver(const char *path)
{
    ...
    if (( ( BaseType_t ) 1 ) != xQueueGenericSend( ( QueueHandle_t ) ( g_vfs_mutex ), 
# 58 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c" 3 4
                 ((void *)0)
# 58 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c"
                 , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) )) {
        err = -1;
        return err;
    }
...
{
    inode_t *node = 
# 68 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c" 3 4
                   ((void *)0)
# 68 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c"
                       ;
    int err, ret;
    ...
    if (( ( BaseType_t ) 1 ) != xQueueGenericSend( ( QueueHandle_t ) ( g_vfs_mutex ), 
# 84 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c" 3 4
                 ((void *)0)
# 84 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c"
                 , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) )) {
        err = -1;
        if (node->i_name != 
# 86 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c" 3 4
                           ((void *)0)
# 86 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c"
                               ) {
            vPortFree(node->i_name);
        }
...
int aos_unregister_fs(const char *path)
{
    ...
    if (( ( BaseType_t ) 1 ) != xQueueGenericSend( ( QueueHandle_t ) ( g_vfs_mutex ), 
# 108 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c" 3 4
                 ((void *)0)
# 108 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/src/vfs_register.c"
                 , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) )) {
        err = -1;
        return err;
    }
