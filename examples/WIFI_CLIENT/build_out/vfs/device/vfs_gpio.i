# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
...
# 5 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 2
...
# 6 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 2
...
# 7 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 2
...
# 512 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 8 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 2
...
# 10 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/include/device/vfs_gpio.h" 1
# 12 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/include/device/vfs_gpio.h"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/include/vfs_inode.h" 1
# 13 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/include/device/vfs_gpio.h" 2


extern const struct file_ops gpio_ops;
# 24 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/include/device/vfs_gpio.h"
int vfs_gpio_open(inode_t *inode, file_t *fp);
# 33 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/include/device/vfs_gpio.h"
int vfs_gpio_close(file_t *fp);
# 45 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/include/device/vfs_gpio.h"
ssize_t vfs_gpio_write(file_t *fp, const void *buf, size_t nbytes);
# 57 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/include/device/vfs_gpio.h"
ssize_t vfs_gpio_read(file_t *fp, void *buf, size_t nbytes);
# 68 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/include/device/vfs_gpio.h"
int vfs_gpio_ioctl(file_t *fp, int cmd, unsigned long arg);
# 11 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 2
...
# 12 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 2
...
# 13 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 2
...
# 14 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 2
...
int vfs_gpio_open(inode_t *inode, file_t *fp)
{
    int ret = -1;
    gpio_dev_t *gpio_dev = 
# 28 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
                          ((void *)0)
# 28 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
                              ;


    if ((fp != 
# 31 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
              ((void *)0)
# 31 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
                  ) && (fp->node != 
# 31 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
                                    ((void *)0)
# 31 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
...
int vfs_gpio_close(file_t *fp)
{
    int ret = -1;
    gpio_dev_t *gpio_dev = 
# 54 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
                          ((void *)0)
# 54 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
                              ;


    if ((fp != 
# 57 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
              ((void *)0)
# 57 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
                  ) && (fp->node != 
# 57 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
                                    ((void *)0)
# 57 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
        ...
        if (fp->node->refs == 1) {
            ...
            if (gpio_dev != 
# 65 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
                           ((void *)0)
# 65 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
                               ) {
...
ssize_t vfs_gpio_write(file_t *fp, const void *buf, size_t nbytes)
{
    ...
    uint8_t write_buf;
    gpio_dev_t *gpio_dev = 
# 86 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
                          ((void *)0)
# 86 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
                              ;


    if ((fp != 
# 89 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
              ((void *)0)
# 89 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
                  ) && (fp->node != 
# 89 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
                                    ((void *)0)
# 89 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
        ...
        if (gpio_dev != 
# 94 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
                       ((void *)0)
# 94 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
                           ) {
...
ssize_t vfs_gpio_read(file_t *fp, void *buf, size_t nbytes)
{
    int ret = -1;
    gpio_dev_t *gpio_dev = 
# 124 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
                          ((void *)0)
# 124 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
                              ;


    if ((fp != 
# 127 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
              ((void *)0)
# 127 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
                  ) && (fp->node != 
# 127 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
                                    ((void *)0)
# 127 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
        ...
        if (gpio_dev != 
# 132 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
                       ((void *)0)
# 132 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
                           ) {
            if (GPIO_CONFIG_MODE_OUTPUT == gpio_dev->config) {
...
int vfs_gpio_ioctl(file_t *fp, int cmd, unsigned long arg)
{
    int ret = -1;
    gpio_dev_t *gpio_dev = 
# 161 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
                          ((void *)0)
# 161 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
                              ;


    if ((fp == 
# 164 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
              ((void *)0)
# 164 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
                  ) || (fp->node == 
# 164 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
                                    ((void *)0)
# 164 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
    ...
    if (gpio_dev == 
# 171 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c" 3 4
                   ((void *)0)
# 171 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/fs/vfs/device/vfs_gpio.c"
                       ) {
        return -22;
    }
