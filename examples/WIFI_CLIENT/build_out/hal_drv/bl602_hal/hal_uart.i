# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
# 30 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
...
# 31 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
...
# 32 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
...
# 33 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
...
# 34 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
...
# 512 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 35 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
...
# 39 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/uart_reg.h"
...
# 40 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/uart_reg.h" 2
...
# 41 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_uart.h" 2
...
# 276 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_uart.h"
...
# 37 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.h" 1
# 38 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
...
# 40 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2

# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/blog/blog.h" 1
# 38 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/blog/blog.h"
...
# 42 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 2
...
# 48 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                              ((void *)0)
# 48 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                                  ;
static uart_dev_t *dev_uart1 = 
# 49 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                              ((void *)0)
# 49 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                                  ;
...
static int uart_dev_malloc(uart_dev_t **pdev)
{
    ...
    *pdev = pvPortMalloc(sizeof(uart_dev_t));
    ...
    (*pdev)->priv = 
# 66 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                   ((void *)0)
# 66 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                       ;
    (*pdev)->priv = pvPortMalloc(sizeof(uart_priv_data_t));
    if ((*pdev)->priv == 
# 68 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                        ((void *)0)
# 68 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                            ) {
        ;
        return -1;
    }
...
{
    if (*pdev == 
# 79 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                ((void *)0)
# 79 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                    ) {
        ;
        return;
    }
...
{
    uart_dev_t **pdev = 
# 97 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                       ((void *)0)
# 97 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                           ;
    int ret;
...
static void fdt_uart_module_init(const void *fdt, int uart_offset)
{
    ...
    uint8_t id;
    char *path = 
# 226 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                ((void *)0)
# 226 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                    ;
    uint32_t baudrate;
    ...
    for (i = 0; i < 2; i++) {
        ...
        if (addr_prop == 
# 294 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                        ((void *)0)
# 294 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                            ) {
            ;
            continue;
        }
        ...
        if (addr_prop == 
# 302 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                        ((void *)0)
# 302 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                            ) {
            ;
            continue;
        }
        ...
        for (j = 0; j < 4; j++) {
            ...
            if (addr_prop == 
# 332 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c" 3 4
                            ((void *)0)
# 332 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_uart.c"
                                ) {
                ;
                continue;
            }
