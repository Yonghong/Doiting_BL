# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
# 31 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
...
# 32 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 2
...
# 33 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 2
...
# 34 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 2
...
# 35 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.h" 1
# 36 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.h"
...
# 36 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 2
...
# 37 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 2
...
# 41 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 2
...
static void hwtimer_process(void *ctx)
{
    hw_timer_t *node;
    void (*handler)(void) = 
# 54 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
                           ((void *)0)
# 54 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
                               ;
    hw_timer_t tmpnode;
    ...
    for (node = ((hw_timer_t *) ((char *) ((pstctx->pstqueue)->next) - ((size_t)&(((hw_timer_t *)0)->dlist_item)))); &node->dlist_item != (pstctx->pstqueue); node = ((hw_timer_t *) ((char *) (node->dlist_item.next) - ((size_t)&(((hw_timer_t *)0)->dlist_item))))) {
...
int hal_hwtimer_init(void)
{
    ...
    if (pstctx == 
# 100 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
                 ((void *)0)
# 100 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
                     ) {
        ;
        return -1;
    }
    ...
    if (pstctx->pstqueue == 
# 106 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
                           ((void *)0)
# 106 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
                               ) {
        vPortFree(pstctx);
        ;
    ...
    pstctx->hwtimer_mux = xQueueCreateMutex( ( ( uint8_t ) 1U ) );
    if (pstctx->hwtimer_mux == 
# 114 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
                              ((void *)0)
# 114 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
                                  ) {
    ...
    bl_irq_register_with_ctx(TIMER_CH0_IRQn, hwtimer_process, pstctx);
...
hw_timer_t *hal_hwtimer_create(uint32_t period, hw_t handler, int repeat)
{
    ...
    if (period <= 0 || handler == 
# 140 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
                                 ((void *)0) 
# 140 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
                                      || (repeat != 0 && repeat != 1)) {
        ;

        return 
# 143 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
              ((void *)0)
# 143 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
                  ;
    }

    bl_irq_ctx_get(TIMER_CH0_IRQn, (void **)&pstctx);
    if( xQueueSemaphoreTake( ( pstctx->hwtimer_mux ), ( ( TickType_t ) 0xffffffffUL ) ) == ( ( BaseType_t ) 1 ) ) {
        ;
    }
    ...
    TIMER_IntMask(TIMER_CH0, TIMER_INT_COMP_0, UNMASK);
    xQueueGenericSend( ( QueueHandle_t ) ( pstctx->hwtimer_mux ), 
# 160 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
   ((void *)0)
# 160 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
...
int hal_hwtimer_delete(hw_timer_t *pstnode)
{
    ...
    TIMER_IntMask(TIMER_CH0, TIMER_INT_COMP_0, UNMASK);
    xQueueGenericSend( ( QueueHandle_t ) ( pstctx->hwtimer_mux ), 
# 193 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
   ((void *)0)
# 193 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    return ret;
}
...
int hal_hwtimer_change_period(hw_timer_t *pstnode, uint32_t period)
{
    ...
    TIMER_IntMask(TIMER_CH0, TIMER_INT_COMP_0, UNMASK);
    xQueueGenericSend( ( QueueHandle_t ) ( pstctx->hwtimer_mux ), 
# 231 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c" 3 4
   ((void *)0)
# 231 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_hwtimer.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    return ret;
}
