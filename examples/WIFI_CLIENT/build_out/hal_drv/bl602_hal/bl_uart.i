# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c"
# 30 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c"
...
# 31 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 2
...
# 32 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 2

# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.h" 1
# 36 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.h"
...
# 34 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 2
...
# 35 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 2
...
static cb_uart_notify_t cbs_notify[2];
static void *cbs_uart_notify_arg[2][8];
...
{
    if (
# 210 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 3 4
       ((void *)0) 
# 210 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c"
            == parity) {
        return;
    }
...
int bl_uart_int_cb_notify_unregister(uint8_t id, cb_uart_notify_t cb, void *arg)
{
    ...
    cbs_uart_notify_arg[id][0] = 
# 308 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 3 4
                                ((void *)0)
# 308 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c"
                                    ;
    cbs_notify[id] =
# 309 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 3 4
                   ((void *)0)
# 309 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c"
                       ;
...
static inline void uart_generic_notify_handler(uint8_t id)
{
    ...
    if(( ((tmpVal)&(1U<<((3U)))) !=0 ) && !( ((maskVal)&(1U<<((3U)))) !=0 )){
        ...
        while (UART_GetRxFifoCount(id) > 0) {
            ...
            ch = (*((volatile uint8_t*)(UARTx + (0x8C))));
            if (((idx_w + 1) & (128 - 1)) != idx_r) {
