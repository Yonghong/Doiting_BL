# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/blestack//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
# 15 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/log.h" 1
# 14 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/log.h"
...
# 15 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/log.h" 2
...
# 16 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 2
...
# 20 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/toolchain/riscv/Linux/lib/gcc/riscv64-unknown-elf/8.3.0/include/stddef.h" 1 3 4
# 21 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 2
...
# 23 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 2
# 61 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
...
{
# 86 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
...
# 175 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
static u8_t *fixed_data_alloc(struct net_buf *buf, size_t *size, s32_t timeout)
{
 struct net_buf_pool *pool = net_buf_pool_get(buf->pool_id);
 const struct net_buf_pool_fixed *fixed = pool->alloc->alloc_data;

 *size = (((fixed->data_size) < (*size)) ? (fixed->data_size) : (*size));
...
# 235 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
...

{
 ...
 if (pool->uninit_count) {
  ...
  if (pool->uninit_count < pool->buf_count) {
   buf = k_queue_get((struct k_queue *) &pool->free, 0);
   if (buf) {
    irq_unlock(key);
    goto success;
   }
 ...
 irq_unlock(key);
# 337 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
 buf = k_queue_get((struct k_queue *) &pool->free, timeout);

 if (!buf) {
  ;
  return 
# 341 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 3 4
        ((void *)0)
# 341 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
            ;
 }
...
success:
 ...
 if (size) {
  ...
  if (!buf->__buf) {
   ...
   net_buf_destroy(buf);
   return 
# 359 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 3 4
         ((void *)0)
# 359 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
             ;
  }
 } else {
  buf->__buf = 
# 362 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 3 4
              ((void *)0)
# 362 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
                  ;
 }
 ...
 buf->flags = 0U;
 buf->frags = 
# 367 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 3 4
             ((void *)0)
# 367 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
                 ;
 buf->size = size;
 net_buf_reset(buf);
...
# 390 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
struct net_buf *net_buf_alloc_fixed(struct net_buf_pool *pool, s32_t timeout)
{
 const struct net_buf_pool_fixed *fixed = pool->alloc->alloc_data;
...
# 404 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
struct net_buf *net_buf_alloc_with_data(struct net_buf_pool *pool,
     void *data, size_t size,
     s32_t timeout)

{
 ...
 if (!buf) {
  return 
# 417 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 3 4
        ((void *)0)
# 417 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
            ;
 }
...

{
 ...
 buf = k_queue_get((struct k_queue *) fifo, timeout);
 if (!buf) {
  return 
# 442 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 3 4
        ((void *)0)
# 442 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
            ;
 }
 ...
 for (frag = buf; (frag->flags & (1UL << (0))); frag = frag->frags) {
  frag->frags = k_queue_get((struct k_queue *) fifo, 0);
  ;
 ...
 frag->frags = 
# 457 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 3 4
              ((void *)0)
# 457 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
                  ;
...
struct net_buf *net_buf_slist_get(sys_slist_t *list)
{
 ...
 if (!buf) {
  return 
# 500 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 3 4
        ((void *)0)
# 500 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
            ;
 }
 ...
 frag->frags = 
# 516 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 3 4
              ((void *)0)
# 516 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
                  ;
...
void net_buf_put(struct k_fifo *fifo, struct net_buf *buf)
{
 ...
 k_queue_append_list((struct k_queue *) fifo, buf, tail);
}
...
# 559 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
  ...
  if (buf->__buf) {
   ...
   buf->__buf = 
# 568 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 3 4
               ((void *)0)
# 568 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
                   ;
  }

  buf->data = 
# 571 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 3 4
             ((void *)0)
# 571 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
                 ;
  buf->frags = 
# 572 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 3 4
              ((void *)0)
# 572 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
                  ;
...
struct net_buf *net_buf_clone(struct net_buf *buf, s32_t timeout)
{
 ...
 if (!clone) {
  return 
# 620 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 3 4
        ((void *)0)
# 620 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
            ;
 }
 ...
 if (pool->alloc->cb->ref && !(buf->flags & (1UL << (1)))) {
  ...
  if (!clone->__buf || size < buf->size) {
   ...
   return 
# 643 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 3 4
         ((void *)0)
# 643 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
             ;
  }

  clone->size = size;
  clone->data = clone->__buf + net_buf_simple_headroom(&(buf)->b);
  net_buf_simple_add_mem(&(clone)->b, buf->data, buf->len);
 }
...

{
 ...
 frag->frags = 
# 710 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c" 3 4
              ((void *)0)
# 710 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
                  ;
    ...
    size_t offset, size_t len)
{
 ...
 copied = 0;
 while (frag && len > 0) {
  to_copy = (((len) < (frag->len - offset)) ? (len) : (frag->len - offset));
       ...
       net_buf_allocator_cb allocate_cb, void *user_data)
{
 ...
 do {
  u16_t count = (((len) < (net_buf_simple_tailroom(&(frag)->b))) ? (len) : (net_buf_simple_tailroom(&(frag)->b)));

  net_buf_simple_add_mem(&(frag)->b, value8, count);
  len -= count;
  added_len += count;
  value8 += count;
...
# 807 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/buf.c"
...
u16_t net_buf_simple_pull_le16(struct net_buf_simple *buf)
{
 ...
 val = __extension__ ({ struct __attribute__((__packed__)) { __typeof__(*((u16_t *)buf->data)) __v; } *__p = (__typeof__(__p)) ((u16_t *)buf->data); __p->__v; });
...
u16_t net_buf_simple_pull_be16(struct net_buf_simple *buf)
{
 ...
 return ((u16_t) ((((val) >> 8) & 0xff) | (((val) & 0xff) << 8)));
}
...
u32_t net_buf_simple_pull_le32(struct net_buf_simple *buf)
{
 ...
 val = __extension__ ({ struct __attribute__((__packed__)) { __typeof__(*((u32_t *)buf->data)) __v; } *__p = (__typeof__(__p)) ((u32_t *)buf->data); __p->__v; });
 net_buf_simple_pull(buf, sizeof(val));
...
u32_t net_buf_simple_pull_be32(struct net_buf_simple *buf)
{
 ...
 return ((u32_t) ((((val) >> 24) & 0xff) | (((val) >> 8) & 0xff00) | (((val) & 0xff00) << 8) | (((val) & 0xff) << 24)));
}
