# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/blestack//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
# 15 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
...
# 16 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 2
...
# 17 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 2
...
# 18 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 2
...
static timer_rec_d timer_records[5];
...
{
    timer_rec_init();
    k_queue_init((struct k_queue *) &g_work_queue_main.fifo, 20);
    return k_thread_create(&work_q_thread, "work_q_thread",
                           1536,
                           work_queue_main, (( 32 ) - 2));
}
...
static void work_timeout(void *timer)
{
    ...
    if( ( rec != 
# 82 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 3 4
   ((void *)0) 
# 82 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
    ...
    w->work_q = 
# 89 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 3 4
               ((void *)0)
# 89 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
                   ;
    rec->timer.hdl = 
# 90 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 3 4
                    ((void *)0)
# 90 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
                        ;
}
...
void k_delayed_work_init(struct k_delayed_work *work, k_work_handler_t handler)
{
    ...
    work->work_q = 
# 98 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 3 4
                  ((void *)0)
# 98 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
                      ;
}
        ...
        uint32_t delay)
{
    ...
    if (!delay) {
        ...
        work->work_q = 
# 128 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 3 4
                      ((void *)0)
# 128 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
                          ;
    } else {
...
int k_delayed_work_cancel(struct k_delayed_work *work)
{
    ...
    work->work_q = 
# 172 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 3 4
                  ((void *)0)
# 172 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
                      ;
...
s32_t k_delayed_work_remaining_get(struct k_delayed_work *work)
{
    ...
    if (work == 
# 186 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 3 4
               ((void *)0)
# 186 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
                   ) {
        return 0;
    }
...
{
    if(
# 200 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 3 4
      ((void *)0) 
# 200 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
           == work || 
# 200 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 3 4
                      ((void *)0) 
# 200 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
                           == work->timer.timer.hdl)
        return;

    k_timer_delete(&work->timer);
    work->timer.timer.hdl = 
# 204 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 3 4
                           ((void *)0)
# 204 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
                               ;
}
...
static void timer_rec_init()
{
    for(int i = 0; i < ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(timer_records), __typeof__(&(timer_records)[0])))]) - 1) + (sizeof(timer_records) / sizeof((timer_records)[0])))); i++)
    {
        timer_records[i].timer.hdl = 
# 218 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 3 4
                                    ((void *)0)
# 218 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
                                        ;
        timer_records[i].delay_work = 
# 219 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 3 4
                                     ((void *)0)
# 219 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
                                         ;
    }
}
...
static int alloc_timer_record(struct k_delayed_work *delay_work)
{
     for(int i = 0; i < ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(timer_records), __typeof__(&(timer_records)[0])))]) - 1) + (sizeof(timer_records) / sizeof((timer_records)[0])))); i++)
    {
        if(timer_records[i].timer.hdl == 
# 227 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 3 4
                                        ((void *)0)
# 227 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
                                            )
        {
...
int remv_timer_record(struct k_delayed_work *delay_work)
{
    for(int i = 0; i < ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(timer_records), __typeof__(&(timer_records)[0])))]) - 1) + (sizeof(timer_records) / sizeof((timer_records)[0])))); i++)
    {
        ...
        {
            timer_records[i].timer.hdl = 
# 254 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 3 4
                                        ((void *)0)
# 254 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
                                            ;
            break;
        }
    }
...
timer_rec_d *get_timer_record(void *hdl)
{
    ...
    return 
# 269 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c" 3 4
          ((void *)0)
# 269 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/work_q.c"
              ;
}
