# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/blestack//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c"
# 17 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c"
...
# 18 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c" 2
...
# 20 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c" 2



# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/include/misc/__assert.h" 1
# 24 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c" 2
         ...
         int mode, void *obj)
{
 ...
 event->poller = 
# 35 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c" 3 4
                ((void *)0)
# 35 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c"
                    ;
...
{
 event->poller = 
# 115 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c" 3 4
                ((void *)0)
# 115 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c"
                    ;
...
{
 event->poller = 
# 153 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c" 3 4
                ((void *)0)
# 153 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c"
                    ;
 event->state |= state;
}

static 
# 157 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c" 3 4
      _Bool 
# 157 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c"
           polling_events(struct k_poll_event *events, int num_events,
                    s32_t timeout, int *last_registered)
{
    int rc;
    
# 161 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c" 3 4
   _Bool 
# 161 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c"
        polling = 
# 161 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c" 3 4
                  1
# 161 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c"
    ...
    for (int ii = 0; ii < num_events; ii++) {
        ...
        if (is_condition_met(&events[ii], &state)) {
            ...
            polling = 
# 169 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c" 3 4
                     0
# 169 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c"
                          ;
        } else if (timeout != 0 && polling) {
            rc = register_event(&events[ii], 
# 171 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c" 3 4
                                            ((void *)0)
# 171 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c"
                                                );
            if (rc == 0) {
                ++(*last_registered);
            } else {
...
# 190 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c" 3 4
       _Bool 
# 190 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c"
            polling = 
# 190 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c" 3 4
                      1
# 190 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c"
        ...
        if (polling == 
# 195 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c" 3 4
                      0
# 195 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/poll.c"
                           ) {
            goto exit;
        }
...
int k_poll_signal_raise(struct k_poll_signal *signal, int result)
{
 ...
 int rc = _signal_poll_event(poll_event, 2,
        &must_reschedule);
