# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
...
# 2 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/include/bluetooth/conn.h" 1
# 20 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/include/bluetooth/conn.h"
...
# 21 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/include/bluetooth/conn.h" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/include/bluetooth/bluetooth.h" 1
# 21 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/include/bluetooth/bluetooth.h"
...
# 22 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/include/bluetooth/bluetooth.h" 2
...
# 16 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/include/misc/printk.h" 2
...
# 24 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/include/bluetooth/bluetooth.h" 2
...
void bt_foreach_bond(u8_t id, void (*func)(const struct bt_bond_info *info,
        void *user_data),
       void *user_data);
# 22 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/include/bluetooth/conn.h" 2
...
# 3 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 2
...
# 4 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 2
...
# 5 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 2
...
# 6 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 2
...
# 7 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 2
...
# 8 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 2
...
# 9 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 2





static u8_t selected_id = 0;

# 15 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 3 4
_Bool 
# 15 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
       ble_inited = 
# 15 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 3 4
                     0
# 15 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
...
# 17 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 3 4
                              ((void *)0)
# 17 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
                                  ;
...
struct bt_data ad_discov[2] = {
 { .type = (0x01), .data_len = (sizeof((u8_t []) { (0x02 | 0x04) })), .data = (const u8_t *)(((u8_t []) { (0x02 | 0x04) })), },
    ...
    { .type = (0x09), .data_len = (13), .data = (const u8_t *)("BL602-BLE-DEV"), },
...
const struct cli_command btStackCmdSet[] __attribute__((used, section(".static_cli_cmds"))) = {
# 190 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
    {"ble_init", "", ble_init},
...
static void disconnected(struct bt_conn *conn, u8_t reason)
{
 ...
 if (default_conn == conn) {
  default_conn = 
# 268 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 3 4
                ((void *)0)
# 268 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
                    ;
 }
}
...
{
    if(ble_inited){
        printf("Has initialized \r\n");
        return;
    }


    default_conn = 
# 319 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 3 4
                  ((void *)0)
# 319 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
                      ;
    bt_conn_cb_register(&conn_callbacks);

    ble_inited = 
# 322 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 3 4
                1
# 322 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
                    ;
...
static void ble_set_device_name(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
 ...
 if(strlen(argv[1]) > 0 && strlen(argv[1])<=20){
  ...
  if(err){
   ...
   printf("Set the device name successfully\r\n");
 }else{
...
static 
# 353 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 3 4
      _Bool 
# 353 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
           data_cb(struct bt_data *data, void *user_data)
{
 char *name = user_data;
    u8_t len;
 ...
 case 0x09:
  ...
  return 
# 363 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 3 4
        0
# 363 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
             ;
 default:
  return 
# 365 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 3 4
        1
# 365 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
            ;
 }
}
...
static void ble_set_adv_channel(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    ...
    {
        printf("Set adv channel success\r\n");
    }
    else
    {
        printf("Failed to Set adv channel\r\n");
    }
}
  ...
  printf("tmp 0x%x\r\n",tmp);
    if(tmp == 0 || tmp == 1 || tmp == 2){
        ...
        if(tmp == 1)
            ad_discov[0].data = 0;
        ad = ad_discov;
        ad_len = ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(ad_discov), __typeof__(&(ad_discov)[0])))]) - 1) + (sizeof(ad_discov) / sizeof((ad_discov)[0]))));

    }else{
        printf("Arg2 is invalid\r\n");
        return;
    }
    ...
    if(adv_type == 1){
        ...
        err = bt_le_adv_start(&param, ad, ad_len, 
# 525 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 3 4
                                                 ((void *)0)
# 525 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
                                                     , 0);
    }
...
static void ble_disconnect(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
 ...
 s8_t type = -1;
    ...
    if(bt_conn_disconnect(conn, 0x13)){
...
{
    int err;
    u8_t sec_level = BT_SECURITY_L4;

    if(!default_conn){
        printf("Please firstly choose the connection using ble_select_conn\r\n");
        return;
    }
...
static void auth_pairing_complete(struct bt_conn *conn, 
# 781 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 3 4
                                                       _Bool 
# 781 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
                                                            bonded)
{
 char addr[30];
...
static void ble_auth_cancel(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
 ...
 if (default_conn) {
  ...
  conn = 
# 828 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 3 4
        ((void *)0)
# 828 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
            ;
 }
...
static struct bt_uuid_16 uuid = { .uuid = { BT_UUID_TYPE_16 }, .val = (0), };
...
u8_t discover_func(struct bt_conn *conn, const struct bt_gatt_attr *attr, struct bt_gatt_discover_params *params)
{
 ...
 case BT_GATT_DISCOVER_INCLUDE:
  ...
  printf("Include %s found: handle %x, start %x, end %x\r\n", str, attr->handle, gatt_include->start_handle, gatt_include->end_handle)
                                                            ;
  break;
 default:
...
# 1034 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 3 4
                              ((void *)0)
# 1034 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
                                  ;
...
static u8_t gatt_write_buf[512];
...
# 1158 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c" 3 4
_Bool 
# 1158 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/cli_cmds/ble_cli_cmds.c"
     sign;
...
static void ble_set_data_len(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
 ...
 {
  printf("ble_set_data_len, LE Set Data Length success\r\n");
 }
}
...
static void ble_set_tx_pwr(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
  ...
  printf("ble_set_tx_pwr, Set tx power successfully\r\n");
 }
