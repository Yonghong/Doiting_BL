# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c"
...
# 5 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 2
...
# 6 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/include/zephyr/types.h" 1
# 10 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/include/zephyr/types.h"
...
# 11 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/include/zephyr/types.h" 2
...
# 7 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 2
...
# 28 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/include/misc/slist.h"
struct _snode {
 struct _snode *next;
};
...
void bt_foreach_bond(u8_t id, void (*func)(const struct bt_bond_info *info,
        void *user_data),
       void *user_data);
# 9 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 2
...
# 10 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 2
...
# 11 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 2

# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.h" 1
# 23 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.h"
...
# 13 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 2
...
# 14 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 2

u8_t local_seq_num = 0x00;
u8_t remote_seq_num = 0xff;
...
static 
# 38 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 3 4
      _Bool 
# 38 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c"
           remote_need_ack(u8_t ack)
{
 return (ack & 0x08) ? 1 : 0;
}

static struct bt_gatt_attr attrs[]= {
 { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid = { BT_UUID_TYPE_16 }, .val = (0x2800), })), .perm = BT_GATT_PERM_READ, .read = bt_gatt_attr_read_service, .write = 
# 44 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 3 4
((void *)0)
# 44 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c"
, .user_data = ((struct bt_uuid *) (&(struct bt_uuid_128) { .uuid = { BT_UUID_TYPE_128 }, .val = { (((0x02fcdc4e7412) >> 0) & 0xFF), (((0x02fcdc4e7412) >> 8) & 0xFF), (((0x02fcdc4e7412) >> 16) & 0xFF), (((0x02fcdc4e7412) >> 24) & 0xFF), (((0x02fcdc4e7412) >> 32) & 0xFF), (((0x02fcdc4e7412) >> 40) & 0xFF), (((0xb294) >> 0) & 0xFF), (((0xb294) >> 8) & 0xFF), (((0x11ea) >> 0) & 0xFF), (((0x11ea) >> 8) & 0xFF), (((0x9f1f) >> 0) & 0xFF), (((0x9f1f) >> 8) & 0xFF), (((0x07af8aa0) >> 0) & 0xFF), (((0x07af8aa0) >> 8) & 0xFF), (((0x07af8aa0) >> 16) & 0xFF), (((0x07af8aa0) >> 24) & 0xFF) }, })), },
...
# 45 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 3 4
((void *)0)
# 45 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c"
, .user_data = (&(struct bt_gatt_chrc) { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_128) { .uuid = { BT_UUID_TYPE_128 }, .val = { (((0x02fcdc4e7412) >> 0) & 0xFF), (((0x02fcdc4e7412) >> 8) & 0xFF), (((0x02fcdc4e7412) >> 16) & 0xFF), (((0x02fcdc4e7412) >> 24) & 0xFF), (((0x02fcdc4e7412) >> 32) & 0xFF), (((0x02fcdc4e7412) >> 40) & 0xFF), (((0xb294) >> 0) & 0xFF), (((0xb294) >> 8) & 0xFF), (((0x11ea) >> 0) & 0xFF), (((0x11ea) >> 8) & 0xFF), (((0x9f1f) >> 0) & 0xFF), (((0x9f1f) >> 8) & 0xFF), (((0x07af8aa2) >> 0) & 0xFF), (((0x07af8aa2) >> 8) & 0xFF), (((0x07af8aa2) >> 16) & 0xFF), (((0x07af8aa2) >> 24) & 0xFF) }, })), .value_handle = 0U, .properties = 0x02 | 0x10, }), }, { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_128) { .uuid = { BT_UUID_TYPE_128 }, .val = { (((0x02fcdc4e7412) >> 0) & 0xFF), (((0x02fcdc4e7412) >> 8) & 0xFF), (((0x02fcdc4e7412) >> 16) & 0xFF), (((0x02fcdc4e7412) >> 24) & 0xFF), (((0x02fcdc4e7412) >> 32) & 0xFF), (((0x02fcdc4e7412) >> 40) & 0xFF), (((0xb294) >> 0) & 0xFF), (((0xb294) >> 8) & 0xFF), (((0x11ea) >> 0) & 0xFF), (((0x11ea) >> 8) & 0xFF), (((0x9f1f) >> 0) & 0xFF), (((0x9f1f) >> 8) & 0xFF), (((0x07af8aa2) >> 0) & 0xFF), (((0x07af8aa2) >> 8) & 0xFF), (((0x07af8aa2) >> 16) & 0xFF), (((0x07af8aa2) >> 24) & 0xFF) }, })), .perm = BT_GATT_PERM_READ, .read = read_data, .write = 
# 45 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 3 4
((void *)0)
# 45 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c"
, .user_data = 
...
, }
 ...
 { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid = { BT_UUID_TYPE_16 }, .val = (0x2902), })), .perm = BT_GATT_PERM_READ_AUTHEN | BT_GATT_PERM_WRITE_AUTHEN, .read = bt_gatt_attr_read_ccc, .write = bt_gatt_attr_write_ccc, .user_data = (&(struct _bt_gatt_ccc) { .cfg = {}, .cfg_changed = wifiprov_ccc_cfg_changed, .cfg_write = 
# 52 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 3 4
((void *)0)
# 52 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c"
, .cfg_match = 
# 52 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 3 4
((void *)0)
# 52 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c"
, }), },
 ...
 { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid = { BT_UUID_TYPE_16 }, .val = (0x2803), })), .perm = BT_GATT_PERM_READ, .read = bt_gatt_attr_read_chrc, .write = 
# 54 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 3 4
((void *)0)
# 54 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c"
, .user_data = (&(struct bt_gatt_chrc) { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_128) { .uuid = { BT_UUID_TYPE_128 }, .val = { (((0x02fcdc4e7412) >> 0) & 0xFF), (((0x02fcdc4e7412) >> 8) & 0xFF), (((0x02fcdc4e7412) >> 16) & 0xFF), (((0x02fcdc4e7412) >> 24) & 0xFF), (((0x02fcdc4e7412) >> 32) & 0xFF), (((0x02fcdc4e7412) >> 40) & 0xFF), (((0xb294) >> 0) & 0xFF), (((0xb294) >> 8) & 0xFF), (((0x11ea) >> 0) & 0xFF), (((0x11ea) >> 8) & 0xFF), (((0x9f1f) >> 0) & 0xFF), (((0x9f1f) >> 8) & 0xFF), (((0x07af8aa1) >> 0) & 0xFF), (((0x07af8aa1) >> 8) & 0xFF), (((0x07af8aa1) >> 16) & 0xFF), (((0x07af8aa1) >> 24) & 0xFF) }, })), .value_handle = 0U, .properties = 0x08 | 0x04, }), }, { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_128) { .uuid = { BT_UUID_TYPE_128 }, .val = { (((0x02fcdc4e7412) >> 0) & 0xFF), (((0x02fcdc4e7412) >> 8) & 0xFF), (((0x02fcdc4e7412) >> 16) & 0xFF), (((0x02fcdc4e7412) >> 24) & 0xFF), (((0x02fcdc4e7412) >> 32) & 0xFF), (((0x02fcdc4e7412) >> 40) & 0xFF), (((0xb294) >> 0) & 0xFF), (((0xb294) >> 8) & 0xFF), (((0x11ea) >> 0) & 0xFF), (((0x11ea) >> 8) & 0xFF), (((0x9f1f) >> 0) & 0xFF), (((0x9f1f) >> 8) & 0xFF), (((0x07af8aa1) >> 0) & 0xFF), (((0x07af8aa1) >> 8) & 0xFF), (((0x07af8aa1) >> 16) & 0xFF), (((0x07af8aa1) >> 24) & 0xFF) }, })), .perm = BT_GATT_PERM_WRITE, .read = 
# 54 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 3 4
((void *)0)
# 54 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c"
, .write = write_data, .user_data = 
# 54 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c" 3 4
((void *)0)
# 54 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/services/wifi_prov.c"
, }
          ...
          u16_t len, u16_t offset, u8_t flags)
{
    ...
    memcpy(&rcvd_frm, buf, 4);
    type = rcvd_frm.type & 0x03;
    subtype = rcvd_frm.type >> 0x02;



    if(remote_seq_num != 0xff && rcvd_frm.sequence_number <= remote_seq_num)
    {
        printf("Old sequence number,reject!""\r\n");
        return len;
    }
    else
    ...
    if(rcvd_frm.len > 0)
        rcvd_frm.data = (u8_t *)(buf + 4);

    if(remote_need_ack(rcvd_frm.frame_control)){
        ack_buf[0] = 0x00|(SUB_TYPE_CTRL_ACK << 0x02);
  ack_buf[1] = 0x00;
  ...
  bt_gatt_notify(conn,&attrs[2],ack_buf,5);
    ...
    callback->local_disconnect_remote_ap();
        ...
        default:
            printf("Invalid wifi prov frame type""\r\n");
        }
    }else if(type == 0x01){
        switch(subtype){
...
struct bt_gatt_service wifiprov_server = { .attrs = attrs, .attr_count = ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(attrs), __typeof__(&(attrs)[0])))]) - 1) + (sizeof(attrs) / sizeof((attrs)[0])))), };
