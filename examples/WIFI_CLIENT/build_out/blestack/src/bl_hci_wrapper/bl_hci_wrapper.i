# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/blestack//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c"
# 13 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c"
...
# 14 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c" 2
...
# 15 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c" 2
...
# 17 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c" 2
...
# 18 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/../common/include/errno.h" 1
# 25 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/../common/include/errno.h"
extern int *__errno(void);
# 19 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c" 2
...
# 20 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blecontroller/ble_inc/hci_onchip.h" 1
# 33 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blecontroller/ble_inc/hci_onchip.h"
enum{
    BT_HCI_CMD,
    BT_HCI_ACL_DATA,
    BT_HCI_CMD_CMP_EVT,
...
# 21 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c" 2
...
struct rx_msg_struct* bl_find_valid_queued_entry(void)
{
    ...
    return 
# 48 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c" 3 4
          ((void *)0)
# 48 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c"
              ;
}
...
void bl_handle_queued_msg(void)
{
    ...
    msg = k_queue_get((struct k_queue *) &msg_queue, 0);
...
int bl_onchiphci_send_2_controller(struct net_buf *buf)
{
   ...
   case BT_BUF_CMD:
 {
        ...
        net_buf_simple_pull(&(buf)->b, sizeof(struct bt_hci_cmd_hdr));
 ...
 case BT_BUF_ACL_OUT:
 {
  ...
  uint16_t connhdl_l2cf, tlt_len;
        ...
        net_buf_simple_pull(&(buf)->b, sizeof(struct bt_hci_acl_hdr));

        if(buf->len < tlt_len)
            return -22;


  dest_id = ((connhdl_l2cf) & 0x0fff);
        pkt.p.acl_data.conhdl = dest_id;
        pkt.p.acl_data.pb_bc_flag = ((connhdl_l2cf) >> 12);
        pkt.p.acl_data.len = tlt_len;
        pkt.p.acl_data.buffer = (uint8_t *)buf->data;
# 206 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c"
  break;
 }
...
# 226 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c" 3 4
_Bool 
# 226 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c"
     prio = 
# 226 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c" 3 4
            1
# 226 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c"
 ...
 struct net_buf *buf = 
# 232 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c" 3 4
                      ((void *)0)
# 232 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c"
                          ;
 static uint32_t monitor = 0;
  ...
  do{
   ...
   if((pkt_type == BT_HCI_LE_EVT && param[0] == 0x02) &&
    (bt_buf_get_rx_avail_cnt() <= (1))){
    break;
   }


        buf = bt_buf_get_rx(buf_type, 0);
  }while(0);
    }
   ...
   puts("hci_rx_pool is not available\n");
        ...
        if(pkt_type == BT_HCI_LE_EVT && param[0] == 0x02)
            ...
            else
            {
                ...
                k_queue_append((struct k_queue *) &msg_queue, rx_msg);
                return;
            }
        }
 ...
 monitor = 0;
    ...
    buf_data = net_buf_simple_tail(&(buf)->b);

 switch(pkt_type)
 {
  case BT_HCI_CMD_CMP_EVT:
  {
            tlt_len = 0x05 + param_len;
            *buf_data++ = 0x0e;
            *buf_data++ = 0x03 + param_len;
  ...
  case BT_HCI_CMD_STAT_EVT:
  {
            ...
            *buf_data++ = nb_h2c_cmd_pkts;
            ...
            sys_put_le16(src_id, buf_data);
# 344 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c"
            break;
  }
  case BT_HCI_LE_EVT:
  {
            prio = 
# 348 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c" 3 4
                  0
# 348 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c"
                       ;
            bt_buf_set_type(buf, BT_BUF_EVT);
   tlt_len = 0x02 + param_len;
            *buf_data++ = 0x3e;
            *buf_data++ = param_len;
            ...
            memcpy(buf_data, param, param_len);
# 365 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c"
   break;
  }
  case BT_HCI_EVT:
  {
            if(src_id != 0x13)
                prio = 
# 370 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c" 3 4
                      0
# 370 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c"
                           ;
            bt_buf_set_type(buf, BT_BUF_EVT);
   tlt_len = 0x02 + param_len;
            *buf_data++ = src_id;
  ...
  {
            prio = 
# 381 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c" 3 4
                  0
# 381 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c"
                       ;
            bt_buf_set_type(buf, BT_BUF_ACL_IN);

            tlt_len = bt_onchiphci_hanlde_rx_acl(param, buf_data);
# 406 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/bl_hci_wrapper/bl_hci_wrapper.c"
   break;
  }
  default:
   return;
    ...
    net_buf_simple_add(&(buf)->b, tlt_len);
