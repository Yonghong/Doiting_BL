# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c"
# 1 "/home/drxiang/programming/Doiting_BL/examples/WIFI_CLIENT/build_out/blestack//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c"
# 9 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c"
...
# 10 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 2
...
# 12 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/include/atomic.h" 1
# 13 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 2
...
# 14 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 2
...
void bt_foreach_bond(u8_t id, void (*func)(const struct bt_bond_info *info,
        void *user_data),
       void *user_data);
# 16 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 2
...
# 17 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 2
...
# 21 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 2
...
# 23 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 2
...
u8_t bt_gatt_check_perm(struct bt_conn *conn, const struct bt_gatt_attr *attr,
   u8_t mask);
# 24 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 2
...
# 25 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 2
...
# 26 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 2
...
# 27 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 2
...
# 28 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 2
...
struct bt_keys *bt_keys_get_addr(u8_t id, const bt_addr_le_t *addr)
{
 struct bt_keys *keys;
 int i;
 size_t first_free_slot = ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(key_pool), __typeof__(&(key_pool)[0])))]) - 1) + (sizeof(key_pool) / sizeof((key_pool)[0]))));

 ;

 for (i = 0; i < ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(key_pool), __typeof__(&(key_pool)[0])))]) - 1) + (sizeof(key_pool) / sizeof((key_pool)[0])))); i++) {
  keys = &key_pool[i];
  ...
  if (first_free_slot == ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(key_pool), __typeof__(&(key_pool)[0])))]) - 1) + (sizeof(key_pool) / sizeof((key_pool)[0])))) &&
      (!bt_addr_le_cmp(&keys->addr, (&(bt_addr_le_t) { 0, { { 0, 0, 0, 0, 0, 0 } } })) ||
       !keys->enc_size)) {
   first_free_slot = i;
  }
 }
 ...
 if (first_free_slot == ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(key_pool), __typeof__(&(key_pool)[0])))]) - 1) + (sizeof(key_pool) / sizeof((key_pool)[0]))))) {
  ...
  for (i = 1; i < ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(key_pool), __typeof__(&(key_pool)[0])))]) - 1) + (sizeof(key_pool) / sizeof((key_pool)[0])))); i++) {
  ...
  if (!bt_addr_le_cmp(&oldest->addr, (&(bt_addr_le_t) { 0, { { 0, 0, 0, 0, 0, 0 } } }))) {
 ...
 return 
# 98 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 3 4
       ((void *)0)
# 98 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c"
           ;
}
...
struct bt_keys *bt_keys_find(int type, u8_t id, const bt_addr_le_t *addr)
{
 ...
 return 
# 144 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 3 4
       ((void *)0)
# 144 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c"
           ;
}
...
struct bt_keys *bt_keys_get_type(int type, u8_t id, const bt_addr_le_t *addr)
{
 ...
 if (!keys) {
  return 
# 160 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 3 4
        ((void *)0)
# 160 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c"
            ;
 }
...
struct bt_keys *bt_keys_find_irk(u8_t id, const bt_addr_le_t *addr)
{
 ...
 if (!bt_addr_le_is_rpa(addr)) {
  return 
# 175 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 3 4
        ((void *)0)
# 175 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c"
            ;
 }
 ...
 return 
# 214 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 3 4
       ((void *)0)
# 214 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c"
           ;
}
...
struct bt_keys *bt_keys_find_addr(u8_t id, const bt_addr_le_t *addr)
{
 ...
 return 
# 230 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c" 3 4
       ((void *)0)
# 230 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c"
           ;
}
...
# 278 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c"
}
...
# 468 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/keys.c"
void bt_keys_update_usage(u8_t id, const bt_addr_le_t *addr)
{
