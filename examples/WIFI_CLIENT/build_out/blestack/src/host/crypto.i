# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c"
...
# 9 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c" 2
...
# 10 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c" 2
...
# 12 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c" 2
...
# 13 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c" 2
...
void bt_foreach_bond(u8_t id, void (*func)(const struct bt_bond_info *info,
        void *user_data),
       void *user_data);
# 15 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c" 2
...
# 17 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c" 2
...
# 19 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/hmac_prng.h" 1
# 71 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/hmac_prng.h"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/sha256.h" 1
# 60 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/sha256.h"
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/toolchain/riscv/Linux/lib/gcc/riscv64-unknown-elf/8.3.0/include/stddef.h" 1 3 4
# 61 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/sha256.h" 2
# 71 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/sha256.h"
...
# 87 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/sha256.h"
int tc_sha256_init(TCSha256State_t s);
# 105 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/sha256.h"
int tc_sha256_update (TCSha256State_t s, const uint8_t *data, size_t datalen);
# 123 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/sha256.h"
int tc_sha256_final(uint8_t *digest, TCSha256State_t s);
# 72 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/hmac_prng.h" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/hmac.h" 1
# 72 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/hmac.h"
...
# 92 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/hmac.h"
int tc_hmac_set_key(TCHmacState_t ctx, const uint8_t *key,
      unsigned int key_size);
# 102 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/hmac.h"
int tc_hmac_init(TCHmacState_t ctx);
# 114 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/hmac.h"
int tc_hmac_update(TCHmacState_t ctx, const void *data,
     unsigned int data_length);
# 133 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/hmac.h"
int tc_hmac_final(uint8_t *tag, unsigned int taglen, TCHmacState_t ctx);
# 73 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/hmac_prng.h" 2
...
# 115 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/hmac_prng.h"
int tc_hmac_prng_init(TCHmacPrng_t prng,
        const uint8_t *personalization,
        unsigned int plen);
# 139 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/hmac_prng.h"
int tc_hmac_prng_reseed(TCHmacPrng_t prng, const uint8_t *seed,
   unsigned int seedlen, const uint8_t *additional_input,
   unsigned int additionallen);
# 158 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/common/tinycrypt/include/tinycrypt/hmac_prng.h"
int tc_hmac_prng_generate(uint8_t *out, unsigned int outlen, TCHmacPrng_t prng);
# 20 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c" 2
...
int tc_aes_decrypt(uint8_t *out, const uint8_t *in,
     const TCAesKeySched_t s);
# 21 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c" 2
...
# 22 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c" 2
...
# 26 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c" 2
...
# 28 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c" 2
...
static int prng_reseed(struct tc_hmac_prng_struct *h)
{
 ...
 for (i = 0; i < (sizeof(seed) / 8); i++) {
  ...
  ret = bt_hci_cmd_send_sync(((0x0018) | ((0x08) << 10)), 
# 41 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c" 3 4
                                               ((void *)0)
# 41 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c"
                                                   , &rsp);
  if (ret) {
   return ret;
  }
...
int prng_init(void)
{
 ...
 if (!(bt_dev.supported_commands[27] & (1UL << (7)))) {
  return -35;
 }

 ret = bt_hci_cmd_send_sync(((0x0018) | ((0x08) << 10)), 
# 75 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c" 3 4
                                              ((void *)0)
# 75 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c"
                                                  , &rsp);
 if (ret) {
  return ret;
 }
...
int bt_rand(void *buf, size_t len)
{
    ...
    return 0;
# 118 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/host/crypto.c"
}
    ...
    u8_t enc_data[16])
{
 ...
 if (tc_aes128_set_encrypt_key(&s, tmp) == 0) {
  return -22;
 }

 sys_memcpy_swap(tmp, plaintext, 16);

 if (tc_aes_encrypt(enc_data, tmp, &s) == 0) {
  return -22;
 }
    ...
    u8_t enc_data[16])
{
 ...
 if (tc_aes_encrypt(enc_data, plaintext, &s) == 0) {
  return -22;
 }
