# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/easyflash_cli.c"
...
# 2 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/easyflash_cli.c" 2
...
# 4 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/easyflash_cli.c" 2
...
# 5 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/easyflash_cli.c" 2
# 1 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/blog/blog.h" 1
# 36 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/blog/blog.h"
...
# 6 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/easyflash_cli.c" 2
...
void psm_test_cmd(char *buf, int len, int argc, char **argv)
{
    ...
    uint8_t *data_src = 
# 45 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/easyflash_cli.c" 3 4
                       ((void *)0)
# 45 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/easyflash_cli.c"
                           ;
    uint8_t *data_buf = 
# 46 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/easyflash_cli.c" 3 4
                       ((void *)0)
# 46 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/easyflash_cli.c"
                           ;
    uint32_t data_len = 0;
    ...
    for (j = 0; j < sizeof(tbuf)/sizeof(tbuf[0]); j++) {
        ...
        if ((
# 60 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/easyflash_cli.c" 3 4
            ((void *)0) 
# 60 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/easyflash_cli.c"
                 == data_src) || (
# 60 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/easyflash_cli.c" 3 4
                                  ((void *)0) 
# 60 "/home/drxiang/programming/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/easyflash_cli.c"
                                       == data_buf)) {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "kvbin malloc %d byte error\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[32mINFO  \x1b[0m", "easyflash_cli.c", 61); ; } while(0==1);
            goto kvbin_exit;
        }

        memset(data_src, 0, data_len + 1);
        ...
        if ((res1 != 0) || (res2 != data_len)) {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "kvbin set/get %ld byte error, res1 = %ld, res2 = %d.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[33mWARN  \x1b[0m", "easyflash_cli.c", 77, data_len, res1, res2); ; } while(0==1);
            goto kvbin_exit;
        }

        if (memcmp(data_buf, data_src, data_len) != 0) {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "kvbin set/get %ld byte , res1 = %ld, res2 = %d. memcmp error\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[31mERROR \x1b[0m", "easyflash_cli.c", 82, data_len, res1, res2); ; } while(0==1);
            goto kvbin_exit;
        }

        do { ; bl_printk("[%10u][%s: %s:%4d] " "kvbin set %ld byte bin -> read %ld byte -> memcmp success.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[32mINFO  \x1b[0m", "easyflash_cli.c", 86, data_len, data_len); ; } while(0==1);
kvbin_exit:
        if (data_src) {
            vPortFree(data_src);
        }
